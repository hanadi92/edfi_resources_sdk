...
class EdFiStudentPersonalIdentificationDocument {
  /// Returns a new [EdFiStudentPersonalIdentificationDocument] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStudentPersonalIdentificationDocument &&
  ...
  /// Returns a new [EdFiStudentPersonalIdentificationDocument] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStudentPersonalIdentificationDocument? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStudentPersonalIdentificationDocument[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStudentPersonalIdentificationDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStudentPersonalIdentificationDocument(
  ...
  static List<EdFiStudentPersonalIdentificationDocument> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStudentPersonalIdentificationDocument>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStudentPersonalIdentificationDocument.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStudentPersonalIdentificationDocument> mapFromJson(dynamic json) {
    final map = <String, EdFiStudentPersonalIdentificationDocument>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStudentPersonalIdentificationDocument.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStudentPersonalIdentificationDocument-objects as value to a dart map
  static Map<String, List<EdFiStudentPersonalIdentificationDocument>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStudentPersonalIdentificationDocument>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStudentPersonalIdentificationDocument.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
