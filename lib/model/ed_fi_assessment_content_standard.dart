...
class EdFiAssessmentContentStandard {
  /// Returns a new [EdFiAssessmentContentStandard] instance.
  ...
  List<EdFiAssessmentContentStandardAuthor> authors;

  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiAssessmentContentStandard &&
  ...
  /// Returns a new [EdFiAssessmentContentStandard] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiAssessmentContentStandard? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiAssessmentContentStandard[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiAssessmentContentStandard[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiAssessmentContentStandard(
        ...
        authors: EdFiAssessmentContentStandardAuthor.listFromJson(json[r'authors']),
      );
    }
    return null;
  }

  static List<EdFiAssessmentContentStandard> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiAssessmentContentStandard>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiAssessmentContentStandard.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiAssessmentContentStandard> mapFromJson(dynamic json) {
    final map = <String, EdFiAssessmentContentStandard>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiAssessmentContentStandard.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiAssessmentContentStandard-objects as value to a dart map
  static Map<String, List<EdFiAssessmentContentStandard>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiAssessmentContentStandard>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiAssessmentContentStandard.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
