...
class EdFiCourseTranscriptAlternativeCourseIdentificationCode {
  /// Returns a new [EdFiCourseTranscriptAlternativeCourseIdentificationCode] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiCourseTranscriptAlternativeCourseIdentificationCode &&
  ...
  @override
  String toString() => 'EdFiCourseTranscriptAlternativeCourseIdentificationCode[courseIdentificationSystemDescriptor=$courseIdentificationSystemDescriptor, assigningOrganizationIdentificationCode=$assigningOrganizationIdentificationCode, courseCatalogURL=$courseCatalogURL, identificationCode=$identificationCode]';
  ...
  /// Returns a new [EdFiCourseTranscriptAlternativeCourseIdentificationCode] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiCourseTranscriptAlternativeCourseIdentificationCode? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiCourseTranscriptAlternativeCourseIdentificationCode[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiCourseTranscriptAlternativeCourseIdentificationCode[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiCourseTranscriptAlternativeCourseIdentificationCode(
  ...
  static List<EdFiCourseTranscriptAlternativeCourseIdentificationCode> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiCourseTranscriptAlternativeCourseIdentificationCode>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiCourseTranscriptAlternativeCourseIdentificationCode.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiCourseTranscriptAlternativeCourseIdentificationCode> mapFromJson(dynamic json) {
    final map = <String, EdFiCourseTranscriptAlternativeCourseIdentificationCode>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiCourseTranscriptAlternativeCourseIdentificationCode.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiCourseTranscriptAlternativeCourseIdentificationCode-objects as value to a dart map
  static Map<String, List<EdFiCourseTranscriptAlternativeCourseIdentificationCode>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiCourseTranscriptAlternativeCourseIdentificationCode>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiCourseTranscriptAlternativeCourseIdentificationCode.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
