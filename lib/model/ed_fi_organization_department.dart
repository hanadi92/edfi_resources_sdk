...
class EdFiOrganizationDepartment {
  /// Returns a new [EdFiOrganizationDepartment] instance.
  EdFiOrganizationDepartment({
    this.id,
    this.categories = const [],
    required this.organizationDepartmentId,
    this.parentEducationOrganizationReference,
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  EdFiEducationOrganizationReference? parentEducationOrganizationReference;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiOrganizationDepartment &&
    other.id == id &&
    _deepEquality.equals(other.categories, categories) &&
    other.organizationDepartmentId == organizationDepartmentId &&
    other.parentEducationOrganizationReference == parentEducationOrganizationReference &&
  ...
  int get hashCode =>
    ...
    (categories.hashCode) +
    (organizationDepartmentId.hashCode) +
    (parentEducationOrganizationReference == null ? 0 : parentEducationOrganizationReference!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.parentEducationOrganizationReference != null) {
      json[r'parentEducationOrganizationReference'] = this.parentEducationOrganizationReference;
    } else {
      json[r'parentEducationOrganizationReference'] = null;
    }
  ...
  /// Returns a new [EdFiOrganizationDepartment] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiOrganizationDepartment? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiOrganizationDepartment[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiOrganizationDepartment[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return EdFiOrganizationDepartment(
        ...
        parentEducationOrganizationReference: EdFiEducationOrganizationReference.fromJson(json[r'parentEducationOrganizationReference']),
  ...
  static List<EdFiOrganizationDepartment> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiOrganizationDepartment>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiOrganizationDepartment.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiOrganizationDepartment> mapFromJson(dynamic json) {
    final map = <String, EdFiOrganizationDepartment>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiOrganizationDepartment.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiOrganizationDepartment-objects as value to a dart map
  static Map<String, List<EdFiOrganizationDepartment>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiOrganizationDepartment>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiOrganizationDepartment.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
