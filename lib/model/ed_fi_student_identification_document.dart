...
class EdFiStudentIdentificationDocument {
  /// Returns a new [EdFiStudentIdentificationDocument] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStudentIdentificationDocument &&
  ...
  /// Returns a new [EdFiStudentIdentificationDocument] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStudentIdentificationDocument? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStudentIdentificationDocument[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStudentIdentificationDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStudentIdentificationDocument(
  ...
  static List<EdFiStudentIdentificationDocument> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStudentIdentificationDocument>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStudentIdentificationDocument.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStudentIdentificationDocument> mapFromJson(dynamic json) {
    final map = <String, EdFiStudentIdentificationDocument>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStudentIdentificationDocument.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStudentIdentificationDocument-objects as value to a dart map
  static Map<String, List<EdFiStudentIdentificationDocument>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStudentIdentificationDocument>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStudentIdentificationDocument.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
