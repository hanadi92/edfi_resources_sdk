...
class TrackedChangesEdFiStudentCompetencyObjectiveKey {
  /// Returns a new [TrackedChangesEdFiStudentCompetencyObjectiveKey] instance.
  TrackedChangesEdFiStudentCompetencyObjectiveKey({
    this.objectiveEducationOrganizationId,
    this.objective,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackedChangesEdFiStudentCompetencyObjectiveKey &&
  ...
  int get hashCode =>
    ...
    (objectiveEducationOrganizationId == null ? 0 : objectiveEducationOrganizationId!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.objectiveEducationOrganizationId != null) {
      ...
      json[r'objectiveEducationOrganizationId'] = null;
    }
  ...
  /// Returns a new [TrackedChangesEdFiStudentCompetencyObjectiveKey] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TrackedChangesEdFiStudentCompetencyObjectiveKey? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackedChangesEdFiStudentCompetencyObjectiveKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackedChangesEdFiStudentCompetencyObjectiveKey[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TrackedChangesEdFiStudentCompetencyObjectiveKey(
  ...
  static List<TrackedChangesEdFiStudentCompetencyObjectiveKey> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TrackedChangesEdFiStudentCompetencyObjectiveKey>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TrackedChangesEdFiStudentCompetencyObjectiveKey.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TrackedChangesEdFiStudentCompetencyObjectiveKey> mapFromJson(dynamic json) {
    final map = <String, TrackedChangesEdFiStudentCompetencyObjectiveKey>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TrackedChangesEdFiStudentCompetencyObjectiveKey.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TrackedChangesEdFiStudentCompetencyObjectiveKey-objects as value to a dart map
  static Map<String, List<TrackedChangesEdFiStudentCompetencyObjectiveKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackedChangesEdFiStudentCompetencyObjectiveKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackedChangesEdFiStudentCompetencyObjectiveKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
