...
class EdFiContactPersonalIdentificationDocument {
  /// Returns a new [EdFiContactPersonalIdentificationDocument] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiContactPersonalIdentificationDocument &&
  ...
  /// Returns a new [EdFiContactPersonalIdentificationDocument] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiContactPersonalIdentificationDocument? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiContactPersonalIdentificationDocument[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiContactPersonalIdentificationDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiContactPersonalIdentificationDocument(
  ...
  static List<EdFiContactPersonalIdentificationDocument> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiContactPersonalIdentificationDocument>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiContactPersonalIdentificationDocument.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiContactPersonalIdentificationDocument> mapFromJson(dynamic json) {
    final map = <String, EdFiContactPersonalIdentificationDocument>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiContactPersonalIdentificationDocument.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiContactPersonalIdentificationDocument-objects as value to a dart map
  static Map<String, List<EdFiContactPersonalIdentificationDocument>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiContactPersonalIdentificationDocument>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiContactPersonalIdentificationDocument.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
