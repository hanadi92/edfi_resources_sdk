...
class EdFiStaffElectronicMail {
  /// Returns a new [EdFiStaffElectronicMail] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStaffElectronicMail &&
  ...
  @override
  String toString() => 'EdFiStaffElectronicMail[electronicMailTypeDescriptor=$electronicMailTypeDescriptor, electronicMailAddress=$electronicMailAddress, doNotPublishIndicator=$doNotPublishIndicator, primaryEmailAddressIndicator=$primaryEmailAddressIndicator]';
  ...
  /// Returns a new [EdFiStaffElectronicMail] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStaffElectronicMail? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStaffElectronicMail[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStaffElectronicMail[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStaffElectronicMail(
  ...
  static List<EdFiStaffElectronicMail> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStaffElectronicMail>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStaffElectronicMail.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStaffElectronicMail> mapFromJson(dynamic json) {
    final map = <String, EdFiStaffElectronicMail>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStaffElectronicMail.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStaffElectronicMail-objects as value to a dart map
  static Map<String, List<EdFiStaffElectronicMail>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStaffElectronicMail>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStaffElectronicMail.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
