...
class EdFiStaffOtherName {
  /// Returns a new [EdFiStaffOtherName] instance.
  EdFiStaffOtherName({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStaffOtherName &&
  ...
  @override
  String toString() => 'EdFiStaffOtherName[otherNameTypeDescriptor=$otherNameTypeDescriptor, firstName=$firstName, generationCodeSuffix=$generationCodeSuffix, lastSurname=$lastSurname, middleName=$middleName, personalTitlePrefix=$personalTitlePrefix]';
  ...
  /// Returns a new [EdFiStaffOtherName] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStaffOtherName? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStaffOtherName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStaffOtherName[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStaffOtherName(
  ...
  static List<EdFiStaffOtherName> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStaffOtherName>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStaffOtherName.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStaffOtherName> mapFromJson(dynamic json) {
    final map = <String, EdFiStaffOtherName>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStaffOtherName.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStaffOtherName-objects as value to a dart map
  static Map<String, List<EdFiStaffOtherName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStaffOtherName>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStaffOtherName.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
