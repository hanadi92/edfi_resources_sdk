...
class EdFiStudentInterventionAssociationInterventionEffectiveness {
  /// Returns a new [EdFiStudentInterventionAssociationInterventionEffectiveness] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStudentInterventionAssociationInterventionEffectiveness &&
  ...
  /// Returns a new [EdFiStudentInterventionAssociationInterventionEffectiveness] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStudentInterventionAssociationInterventionEffectiveness? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStudentInterventionAssociationInterventionEffectiveness[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStudentInterventionAssociationInterventionEffectiveness[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStudentInterventionAssociationInterventionEffectiveness(
  ...
  static List<EdFiStudentInterventionAssociationInterventionEffectiveness> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStudentInterventionAssociationInterventionEffectiveness>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStudentInterventionAssociationInterventionEffectiveness.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStudentInterventionAssociationInterventionEffectiveness> mapFromJson(dynamic json) {
    final map = <String, EdFiStudentInterventionAssociationInterventionEffectiveness>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStudentInterventionAssociationInterventionEffectiveness.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStudentInterventionAssociationInterventionEffectiveness-objects as value to a dart map
  static Map<String, List<EdFiStudentInterventionAssociationInterventionEffectiveness>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStudentInterventionAssociationInterventionEffectiveness>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStudentInterventionAssociationInterventionEffectiveness.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
