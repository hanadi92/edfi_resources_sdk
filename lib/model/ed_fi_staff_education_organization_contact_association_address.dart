...
class EdFiStaffEducationOrganizationContactAssociationAddress {
  /// Returns a new [EdFiStaffEducationOrganizationContactAssociationAddress] instance.
  ...
  List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod> periods;

  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStaffEducationOrganizationContactAssociationAddress &&
  ...
  @override
  String toString() => 'EdFiStaffEducationOrganizationContactAssociationAddress[addressTypeDescriptor=$addressTypeDescriptor, localeDescriptor=$localeDescriptor, stateAbbreviationDescriptor=$stateAbbreviationDescriptor, apartmentRoomSuiteNumber=$apartmentRoomSuiteNumber, buildingSiteNumber=$buildingSiteNumber, city=$city, congressionalDistrict=$congressionalDistrict, countyFIPSCode=$countyFIPSCode, doNotPublishIndicator=$doNotPublishIndicator, latitude=$latitude, longitude=$longitude, nameOfCounty=$nameOfCounty, postalCode=$postalCode, streetNumberName=$streetNumberName, periods=$periods]';
  ...
  /// Returns a new [EdFiStaffEducationOrganizationContactAssociationAddress] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStaffEducationOrganizationContactAssociationAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStaffEducationOrganizationContactAssociationAddress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStaffEducationOrganizationContactAssociationAddress[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStaffEducationOrganizationContactAssociationAddress(
        ...
        periods: EdFiStaffEducationOrganizationContactAssociationAddressPeriod.listFromJson(json[r'periods']),
      );
    }
    return null;
  }

  static List<EdFiStaffEducationOrganizationContactAssociationAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStaffEducationOrganizationContactAssociationAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStaffEducationOrganizationContactAssociationAddress.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStaffEducationOrganizationContactAssociationAddress> mapFromJson(dynamic json) {
    final map = <String, EdFiStaffEducationOrganizationContactAssociationAddress>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStaffEducationOrganizationContactAssociationAddress.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStaffEducationOrganizationContactAssociationAddress-objects as value to a dart map
  static Map<String, List<EdFiStaffEducationOrganizationContactAssociationAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStaffEducationOrganizationContactAssociationAddress>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStaffEducationOrganizationContactAssociationAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
