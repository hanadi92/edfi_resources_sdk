...
class TpdmCandidateElectronicMail {
  /// Returns a new [TpdmCandidateElectronicMail] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TpdmCandidateElectronicMail &&
  ...
  @override
  String toString() => 'TpdmCandidateElectronicMail[electronicMailTypeDescriptor=$electronicMailTypeDescriptor, electronicMailAddress=$electronicMailAddress, doNotPublishIndicator=$doNotPublishIndicator, primaryEmailAddressIndicator=$primaryEmailAddressIndicator]';
  ...
  /// Returns a new [TpdmCandidateElectronicMail] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TpdmCandidateElectronicMail? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TpdmCandidateElectronicMail[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TpdmCandidateElectronicMail[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TpdmCandidateElectronicMail(
  ...
  static List<TpdmCandidateElectronicMail> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TpdmCandidateElectronicMail>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TpdmCandidateElectronicMail.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TpdmCandidateElectronicMail> mapFromJson(dynamic json) {
    final map = <String, TpdmCandidateElectronicMail>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TpdmCandidateElectronicMail.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TpdmCandidateElectronicMail-objects as value to a dart map
  static Map<String, List<TpdmCandidateElectronicMail>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TpdmCandidateElectronicMail>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TpdmCandidateElectronicMail.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
