...
class EdFiStudentEducationOrganizationAssociationInternationalAddress {
  /// Returns a new [EdFiStudentEducationOrganizationAssociationInternationalAddress] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStudentEducationOrganizationAssociationInternationalAddress &&
  ...
  @override
  String toString() => 'EdFiStudentEducationOrganizationAssociationInternationalAddress[addressTypeDescriptor=$addressTypeDescriptor, countryDescriptor=$countryDescriptor, addressLine1=$addressLine1, addressLine2=$addressLine2, addressLine3=$addressLine3, addressLine4=$addressLine4, beginDate=$beginDate, endDate=$endDate, latitude=$latitude, longitude=$longitude]';
  ...
  /// Returns a new [EdFiStudentEducationOrganizationAssociationInternationalAddress] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStudentEducationOrganizationAssociationInternationalAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStudentEducationOrganizationAssociationInternationalAddress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStudentEducationOrganizationAssociationInternationalAddress[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStudentEducationOrganizationAssociationInternationalAddress(
  ...
  static List<EdFiStudentEducationOrganizationAssociationInternationalAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStudentEducationOrganizationAssociationInternationalAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStudentEducationOrganizationAssociationInternationalAddress.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStudentEducationOrganizationAssociationInternationalAddress> mapFromJson(dynamic json) {
    final map = <String, EdFiStudentEducationOrganizationAssociationInternationalAddress>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStudentEducationOrganizationAssociationInternationalAddress.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStudentEducationOrganizationAssociationInternationalAddress-objects as value to a dart map
  static Map<String, List<EdFiStudentEducationOrganizationAssociationInternationalAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStudentEducationOrganizationAssociationInternationalAddress>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStudentEducationOrganizationAssociationInternationalAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
