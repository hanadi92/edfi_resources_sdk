...
class EdFiContactOtherName {
  /// Returns a new [EdFiContactOtherName] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiContactOtherName &&
  ...
  @override
  String toString() => 'EdFiContactOtherName[otherNameTypeDescriptor=$otherNameTypeDescriptor, firstName=$firstName, generationCodeSuffix=$generationCodeSuffix, lastSurname=$lastSurname, middleName=$middleName, personalTitlePrefix=$personalTitlePrefix]';
  ...
  /// Returns a new [EdFiContactOtherName] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiContactOtherName? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiContactOtherName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiContactOtherName[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiContactOtherName(
  ...
  static List<EdFiContactOtherName> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiContactOtherName>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiContactOtherName.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiContactOtherName> mapFromJson(dynamic json) {
    final map = <String, EdFiContactOtherName>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiContactOtherName.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiContactOtherName-objects as value to a dart map
  static Map<String, List<EdFiContactOtherName>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiContactOtherName>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiContactOtherName.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
