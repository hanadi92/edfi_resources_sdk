...
class EdFiStudentEducationOrganizationAssociationTelephone {
  /// Returns a new [EdFiStudentEducationOrganizationAssociationTelephone] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStudentEducationOrganizationAssociationTelephone &&
  ...
  @override
  String toString() => 'EdFiStudentEducationOrganizationAssociationTelephone[telephoneNumberTypeDescriptor=$telephoneNumberTypeDescriptor, telephoneNumber=$telephoneNumber, doNotPublishIndicator=$doNotPublishIndicator, orderOfPriority=$orderOfPriority, textMessageCapabilityIndicator=$textMessageCapabilityIndicator]';
  ...
  /// Returns a new [EdFiStudentEducationOrganizationAssociationTelephone] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStudentEducationOrganizationAssociationTelephone? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStudentEducationOrganizationAssociationTelephone[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStudentEducationOrganizationAssociationTelephone[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStudentEducationOrganizationAssociationTelephone(
  ...
  static List<EdFiStudentEducationOrganizationAssociationTelephone> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStudentEducationOrganizationAssociationTelephone>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStudentEducationOrganizationAssociationTelephone.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStudentEducationOrganizationAssociationTelephone> mapFromJson(dynamic json) {
    final map = <String, EdFiStudentEducationOrganizationAssociationTelephone>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStudentEducationOrganizationAssociationTelephone.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStudentEducationOrganizationAssociationTelephone-objects as value to a dart map
  static Map<String, List<EdFiStudentEducationOrganizationAssociationTelephone>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStudentEducationOrganizationAssociationTelephone>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStudentEducationOrganizationAssociationTelephone.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
