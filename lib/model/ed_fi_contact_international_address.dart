...
class EdFiContactInternationalAddress {
  /// Returns a new [EdFiContactInternationalAddress] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiContactInternationalAddress &&
  ...
  @override
  String toString() => 'EdFiContactInternationalAddress[addressTypeDescriptor=$addressTypeDescriptor, countryDescriptor=$countryDescriptor, addressLine1=$addressLine1, addressLine2=$addressLine2, addressLine3=$addressLine3, addressLine4=$addressLine4, beginDate=$beginDate, endDate=$endDate, latitude=$latitude, longitude=$longitude]';
  ...
  /// Returns a new [EdFiContactInternationalAddress] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiContactInternationalAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiContactInternationalAddress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiContactInternationalAddress[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiContactInternationalAddress(
  ...
  static List<EdFiContactInternationalAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiContactInternationalAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiContactInternationalAddress.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiContactInternationalAddress> mapFromJson(dynamic json) {
    final map = <String, EdFiContactInternationalAddress>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiContactInternationalAddress.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiContactInternationalAddress-objects as value to a dart map
  static Map<String, List<EdFiContactInternationalAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiContactInternationalAddress>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiContactInternationalAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
