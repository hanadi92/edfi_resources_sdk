...
class EdFiEducationOrganizationAddress {
  /// Returns a new [EdFiEducationOrganizationAddress] instance.
  ...
  List<EdFiEducationOrganizationAddressPeriod> periods;

  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiEducationOrganizationAddress &&
  ...
  /// Returns a new [EdFiEducationOrganizationAddress] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiEducationOrganizationAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiEducationOrganizationAddress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiEducationOrganizationAddress[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiEducationOrganizationAddress(
        ...
        periods: EdFiEducationOrganizationAddressPeriod.listFromJson(json[r'periods']),
      );
    }
    return null;
  }

  static List<EdFiEducationOrganizationAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiEducationOrganizationAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiEducationOrganizationAddress.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiEducationOrganizationAddress> mapFromJson(dynamic json) {
    final map = <String, EdFiEducationOrganizationAddress>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiEducationOrganizationAddress.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiEducationOrganizationAddress-objects as value to a dart map
  static Map<String, List<EdFiEducationOrganizationAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiEducationOrganizationAddress>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiEducationOrganizationAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
