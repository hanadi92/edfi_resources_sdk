...
class EdFiStaffRecognition {
  /// Returns a new [EdFiStaffRecognition] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStaffRecognition &&
  ...
  /// Returns a new [EdFiStaffRecognition] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStaffRecognition? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStaffRecognition[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStaffRecognition[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStaffRecognition(
  ...
  static List<EdFiStaffRecognition> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStaffRecognition>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStaffRecognition.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStaffRecognition> mapFromJson(dynamic json) {
    final map = <String, EdFiStaffRecognition>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStaffRecognition.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStaffRecognition-objects as value to a dart map
  static Map<String, List<EdFiStaffRecognition>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStaffRecognition>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStaffRecognition.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
