...
class TpdmCandidateTelephone {
  /// Returns a new [TpdmCandidateTelephone] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TpdmCandidateTelephone &&
  ...
  @override
  String toString() => 'TpdmCandidateTelephone[telephoneNumberTypeDescriptor=$telephoneNumberTypeDescriptor, telephoneNumber=$telephoneNumber, doNotPublishIndicator=$doNotPublishIndicator, orderOfPriority=$orderOfPriority, textMessageCapabilityIndicator=$textMessageCapabilityIndicator]';
  ...
  /// Returns a new [TpdmCandidateTelephone] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TpdmCandidateTelephone? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TpdmCandidateTelephone[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TpdmCandidateTelephone[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TpdmCandidateTelephone(
  ...
  static List<TpdmCandidateTelephone> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TpdmCandidateTelephone>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TpdmCandidateTelephone.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TpdmCandidateTelephone> mapFromJson(dynamic json) {
    final map = <String, TpdmCandidateTelephone>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TpdmCandidateTelephone.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TpdmCandidateTelephone-objects as value to a dart map
  static Map<String, List<TpdmCandidateTelephone>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TpdmCandidateTelephone>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TpdmCandidateTelephone.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
