...
class EdFiLocalPayroll {
  /// Returns a new [EdFiLocalPayroll] instance.
  EdFiLocalPayroll({
    this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiLocalPayroll &&
    other.id == id &&
  ...
  @override
  String toString() => 'EdFiLocalPayroll[id=$id, asOfDate=$asOfDate, localAccountReference=$localAccountReference, staffReference=$staffReference, amount=$amount, financialCollectionDescriptor=$financialCollectionDescriptor, etag=$etag, lastModifiedDate=$lastModifiedDate]';
  ...
  /// Returns a new [EdFiLocalPayroll] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiLocalPayroll? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiLocalPayroll[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiLocalPayroll[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiLocalPayroll(
  ...
  static List<EdFiLocalPayroll> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiLocalPayroll>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiLocalPayroll.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiLocalPayroll> mapFromJson(dynamic json) {
    final map = <String, EdFiLocalPayroll>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiLocalPayroll.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiLocalPayroll-objects as value to a dart map
  static Map<String, List<EdFiLocalPayroll>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiLocalPayroll>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiLocalPayroll.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
