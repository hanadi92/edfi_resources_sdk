...
class EdFiEducationOrganizationInternationalAddress {
  /// Returns a new [EdFiEducationOrganizationInternationalAddress] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiEducationOrganizationInternationalAddress &&
  ...
  @override
  String toString() => 'EdFiEducationOrganizationInternationalAddress[addressTypeDescriptor=$addressTypeDescriptor, countryDescriptor=$countryDescriptor, addressLine1=$addressLine1, addressLine2=$addressLine2, addressLine3=$addressLine3, addressLine4=$addressLine4, beginDate=$beginDate, endDate=$endDate, latitude=$latitude, longitude=$longitude]';
  ...
  /// Returns a new [EdFiEducationOrganizationInternationalAddress] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiEducationOrganizationInternationalAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiEducationOrganizationInternationalAddress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiEducationOrganizationInternationalAddress[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiEducationOrganizationInternationalAddress(
  ...
  static List<EdFiEducationOrganizationInternationalAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiEducationOrganizationInternationalAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiEducationOrganizationInternationalAddress.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiEducationOrganizationInternationalAddress> mapFromJson(dynamic json) {
    final map = <String, EdFiEducationOrganizationInternationalAddress>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiEducationOrganizationInternationalAddress.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiEducationOrganizationInternationalAddress-objects as value to a dart map
  static Map<String, List<EdFiEducationOrganizationInternationalAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiEducationOrganizationInternationalAddress>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiEducationOrganizationInternationalAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
