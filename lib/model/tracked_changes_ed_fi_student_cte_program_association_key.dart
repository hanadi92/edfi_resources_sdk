...
class TrackedChangesEdFiStudentCTEProgramAssociationKey {
  /// Returns a new [TrackedChangesEdFiStudentCTEProgramAssociationKey] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackedChangesEdFiStudentCTEProgramAssociationKey &&
  ...
  @override
  String toString() => 'TrackedChangesEdFiStudentCTEProgramAssociationKey[beginDate=$beginDate, educationOrganizationId=$educationOrganizationId, programEducationOrganizationId=$programEducationOrganizationId, programName=$programName, programTypeDescriptor=$programTypeDescriptor, studentUniqueId=$studentUniqueId]';
  ...
  /// Returns a new [TrackedChangesEdFiStudentCTEProgramAssociationKey] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TrackedChangesEdFiStudentCTEProgramAssociationKey? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackedChangesEdFiStudentCTEProgramAssociationKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackedChangesEdFiStudentCTEProgramAssociationKey[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TrackedChangesEdFiStudentCTEProgramAssociationKey(
  ...
  static List<TrackedChangesEdFiStudentCTEProgramAssociationKey> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TrackedChangesEdFiStudentCTEProgramAssociationKey>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TrackedChangesEdFiStudentCTEProgramAssociationKey.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TrackedChangesEdFiStudentCTEProgramAssociationKey> mapFromJson(dynamic json) {
    final map = <String, TrackedChangesEdFiStudentCTEProgramAssociationKey>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TrackedChangesEdFiStudentCTEProgramAssociationKey.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TrackedChangesEdFiStudentCTEProgramAssociationKey-objects as value to a dart map
  static Map<String, List<TrackedChangesEdFiStudentCTEProgramAssociationKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackedChangesEdFiStudentCTEProgramAssociationKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackedChangesEdFiStudentCTEProgramAssociationKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
