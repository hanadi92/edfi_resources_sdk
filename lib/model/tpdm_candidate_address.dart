...
class TpdmCandidateAddress {
  /// Returns a new [TpdmCandidateAddress] instance.
  ...
  List<TpdmCandidateAddressPeriod> periods;

  @override
  bool operator ==(Object other) => identical(this, other) || other is TpdmCandidateAddress &&
  ...
  /// Returns a new [TpdmCandidateAddress] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TpdmCandidateAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TpdmCandidateAddress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TpdmCandidateAddress[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TpdmCandidateAddress(
        ...
        periods: TpdmCandidateAddressPeriod.listFromJson(json[r'periods']),
      );
    }
    return null;
  }

  static List<TpdmCandidateAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TpdmCandidateAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TpdmCandidateAddress.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TpdmCandidateAddress> mapFromJson(dynamic json) {
    final map = <String, TpdmCandidateAddress>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TpdmCandidateAddress.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TpdmCandidateAddress-objects as value to a dart map
  static Map<String, List<TpdmCandidateAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TpdmCandidateAddress>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TpdmCandidateAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
