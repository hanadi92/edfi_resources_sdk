...
class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey {
  /// Returns a new [TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey &&
  ...
  /// Returns a new [TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey(
  ...
  static List<TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey> mapFromJson(dynamic json) {
    final map = <String, TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey-objects as value to a dart map
  static Map<String, List<TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
