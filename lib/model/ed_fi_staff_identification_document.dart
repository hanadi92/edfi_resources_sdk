...
class EdFiStaffIdentificationDocument {
  /// Returns a new [EdFiStaffIdentificationDocument] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStaffIdentificationDocument &&
  ...
  /// Returns a new [EdFiStaffIdentificationDocument] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStaffIdentificationDocument? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStaffIdentificationDocument[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStaffIdentificationDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStaffIdentificationDocument(
  ...
  static List<EdFiStaffIdentificationDocument> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStaffIdentificationDocument>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStaffIdentificationDocument.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStaffIdentificationDocument> mapFromJson(dynamic json) {
    final map = <String, EdFiStaffIdentificationDocument>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStaffIdentificationDocument.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStaffIdentificationDocument-objects as value to a dart map
  static Map<String, List<EdFiStaffIdentificationDocument>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStaffIdentificationDocument>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStaffIdentificationDocument.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
