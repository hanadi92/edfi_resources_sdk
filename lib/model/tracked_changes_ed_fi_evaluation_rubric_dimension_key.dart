...
class TrackedChangesEdFiEvaluationRubricDimensionKey {
  /// Returns a new [TrackedChangesEdFiEvaluationRubricDimensionKey] instance.
  TrackedChangesEdFiEvaluationRubricDimensionKey({
    this.evaluationRubricRating,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackedChangesEdFiEvaluationRubricDimensionKey &&
  ...
  int get hashCode =>
    ...
    (evaluationRubricRating == null ? 0 : evaluationRubricRating!.hashCode) +
  ...
  /// Returns a new [TrackedChangesEdFiEvaluationRubricDimensionKey] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TrackedChangesEdFiEvaluationRubricDimensionKey? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackedChangesEdFiEvaluationRubricDimensionKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackedChangesEdFiEvaluationRubricDimensionKey[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TrackedChangesEdFiEvaluationRubricDimensionKey(
  ...
  static List<TrackedChangesEdFiEvaluationRubricDimensionKey> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TrackedChangesEdFiEvaluationRubricDimensionKey>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TrackedChangesEdFiEvaluationRubricDimensionKey.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TrackedChangesEdFiEvaluationRubricDimensionKey> mapFromJson(dynamic json) {
    final map = <String, TrackedChangesEdFiEvaluationRubricDimensionKey>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TrackedChangesEdFiEvaluationRubricDimensionKey.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TrackedChangesEdFiEvaluationRubricDimensionKey-objects as value to a dart map
  static Map<String, List<TrackedChangesEdFiEvaluationRubricDimensionKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackedChangesEdFiEvaluationRubricDimensionKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackedChangesEdFiEvaluationRubricDimensionKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
