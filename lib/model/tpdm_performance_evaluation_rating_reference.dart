...
class TpdmPerformanceEvaluationRatingReference {
  /// Returns a new [TpdmPerformanceEvaluationRatingReference] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TpdmPerformanceEvaluationRatingReference &&
  ...
  /// Returns a new [TpdmPerformanceEvaluationRatingReference] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TpdmPerformanceEvaluationRatingReference? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TpdmPerformanceEvaluationRatingReference[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TpdmPerformanceEvaluationRatingReference[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TpdmPerformanceEvaluationRatingReference(
  ...
  static List<TpdmPerformanceEvaluationRatingReference> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TpdmPerformanceEvaluationRatingReference>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TpdmPerformanceEvaluationRatingReference.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TpdmPerformanceEvaluationRatingReference> mapFromJson(dynamic json) {
    final map = <String, TpdmPerformanceEvaluationRatingReference>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TpdmPerformanceEvaluationRatingReference.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TpdmPerformanceEvaluationRatingReference-objects as value to a dart map
  static Map<String, List<TpdmPerformanceEvaluationRatingReference>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TpdmPerformanceEvaluationRatingReference>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TpdmPerformanceEvaluationRatingReference.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
