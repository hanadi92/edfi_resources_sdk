...
class TrackedChangesEdFiStudentHomelessProgramAssociationKey {
  /// Returns a new [TrackedChangesEdFiStudentHomelessProgramAssociationKey] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackedChangesEdFiStudentHomelessProgramAssociationKey &&
  ...
  @override
  String toString() => 'TrackedChangesEdFiStudentHomelessProgramAssociationKey[beginDate=$beginDate, educationOrganizationId=$educationOrganizationId, programEducationOrganizationId=$programEducationOrganizationId, programName=$programName, programTypeDescriptor=$programTypeDescriptor, studentUniqueId=$studentUniqueId]';
  ...
  /// Returns a new [TrackedChangesEdFiStudentHomelessProgramAssociationKey] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TrackedChangesEdFiStudentHomelessProgramAssociationKey? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TrackedChangesEdFiStudentHomelessProgramAssociationKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TrackedChangesEdFiStudentHomelessProgramAssociationKey[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TrackedChangesEdFiStudentHomelessProgramAssociationKey(
  ...
  static List<TrackedChangesEdFiStudentHomelessProgramAssociationKey> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TrackedChangesEdFiStudentHomelessProgramAssociationKey>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TrackedChangesEdFiStudentHomelessProgramAssociationKey.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TrackedChangesEdFiStudentHomelessProgramAssociationKey> mapFromJson(dynamic json) {
    final map = <String, TrackedChangesEdFiStudentHomelessProgramAssociationKey>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TrackedChangesEdFiStudentHomelessProgramAssociationKey.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TrackedChangesEdFiStudentHomelessProgramAssociationKey-objects as value to a dart map
  static Map<String, List<TrackedChangesEdFiStudentHomelessProgramAssociationKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TrackedChangesEdFiStudentHomelessProgramAssociationKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TrackedChangesEdFiStudentHomelessProgramAssociationKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
