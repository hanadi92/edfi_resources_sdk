...
class EdFiStaffPersonalIdentificationDocument {
  /// Returns a new [EdFiStaffPersonalIdentificationDocument] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiStaffPersonalIdentificationDocument &&
  ...
  /// Returns a new [EdFiStaffPersonalIdentificationDocument] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiStaffPersonalIdentificationDocument? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiStaffPersonalIdentificationDocument[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiStaffPersonalIdentificationDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiStaffPersonalIdentificationDocument(
  ...
  static List<EdFiStaffPersonalIdentificationDocument> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiStaffPersonalIdentificationDocument>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiStaffPersonalIdentificationDocument.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiStaffPersonalIdentificationDocument> mapFromJson(dynamic json) {
    final map = <String, EdFiStaffPersonalIdentificationDocument>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiStaffPersonalIdentificationDocument.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiStaffPersonalIdentificationDocument-objects as value to a dart map
  static Map<String, List<EdFiStaffPersonalIdentificationDocument>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiStaffPersonalIdentificationDocument>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiStaffPersonalIdentificationDocument.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
