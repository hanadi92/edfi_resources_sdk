...
class EdFiGraduationPlanRequiredAssessmentScore {
  /// Returns a new [EdFiGraduationPlanRequiredAssessmentScore] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiGraduationPlanRequiredAssessmentScore &&
  ...
  @override
  String toString() => 'EdFiGraduationPlanRequiredAssessmentScore[assessmentReportingMethodDescriptor=$assessmentReportingMethodDescriptor, resultDatatypeTypeDescriptor=$resultDatatypeTypeDescriptor, maximumScore=$maximumScore, minimumScore=$minimumScore]';
  ...
  /// Returns a new [EdFiGraduationPlanRequiredAssessmentScore] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiGraduationPlanRequiredAssessmentScore? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiGraduationPlanRequiredAssessmentScore[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiGraduationPlanRequiredAssessmentScore[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiGraduationPlanRequiredAssessmentScore(
  ...
  static List<EdFiGraduationPlanRequiredAssessmentScore> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiGraduationPlanRequiredAssessmentScore>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiGraduationPlanRequiredAssessmentScore.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiGraduationPlanRequiredAssessmentScore> mapFromJson(dynamic json) {
    final map = <String, EdFiGraduationPlanRequiredAssessmentScore>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiGraduationPlanRequiredAssessmentScore.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiGraduationPlanRequiredAssessmentScore-objects as value to a dart map
  static Map<String, List<EdFiGraduationPlanRequiredAssessmentScore>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiGraduationPlanRequiredAssessmentScore>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiGraduationPlanRequiredAssessmentScore.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
