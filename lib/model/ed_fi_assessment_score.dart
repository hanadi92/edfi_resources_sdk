...
class EdFiAssessmentScore {
  /// Returns a new [EdFiAssessmentScore] instance.
  EdFiAssessmentScore({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EdFiAssessmentScore &&
  ...
  @override
  String toString() => 'EdFiAssessmentScore[assessmentReportingMethodDescriptor=$assessmentReportingMethodDescriptor, resultDatatypeTypeDescriptor=$resultDatatypeTypeDescriptor, maximumScore=$maximumScore, minimumScore=$minimumScore]';
  ...
  /// Returns a new [EdFiAssessmentScore] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EdFiAssessmentScore? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EdFiAssessmentScore[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EdFiAssessmentScore[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EdFiAssessmentScore(
  ...
  static List<EdFiAssessmentScore> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EdFiAssessmentScore>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EdFiAssessmentScore.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EdFiAssessmentScore> mapFromJson(dynamic json) {
    final map = <String, EdFiAssessmentScore>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EdFiAssessmentScore.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EdFiAssessmentScore-objects as value to a dart map
  static Map<String, List<EdFiAssessmentScore>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EdFiAssessmentScore>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EdFiAssessmentScore.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
