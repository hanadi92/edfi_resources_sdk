...
class EvaluationObjectivesApi {
  EvaluationObjectivesApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteEvaluationObjectiveByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteEvaluationObjectiveById(String id, { String? ifMatch, }) async {
    final response = await deleteEvaluationObjectiveByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesEvaluationObjectivesWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives/deletes';
  ...
  Future<List<TrackedChangesTpdmEvaluationObjectiveDelete>?> deletesEvaluationObjectives({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesEvaluationObjectivesWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmEvaluationObjectiveDelete>') as List)
        .cast<TrackedChangesTpdmEvaluationObjectiveDelete>()
  ...
  Future<Response> getEvaluationObjectivesWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? evaluationObjectiveTitle, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? evaluationObjectiveDescription, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    ...
    if (evaluationObjectiveDescription != null) {
      queryParams.addAll(_queryParams('', 'evaluationObjectiveDescription', evaluationObjectiveDescription));
    }
    if (id != null) {
  ...
  Future<List<TpdmEvaluationObjective>?> getEvaluationObjectives({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? evaluationObjectiveTitle, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? evaluationObjectiveDescription, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    final response = await getEvaluationObjectivesWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, evaluationObjectiveTitle: evaluationObjectiveTitle, educationOrganizationId: educationOrganizationId, evaluationPeriodDescriptor: evaluationPeriodDescriptor, evaluationTitle: evaluationTitle, performanceEvaluationTitle: performanceEvaluationTitle, performanceEvaluationTypeDescriptor: performanceEvaluationTypeDescriptor, schoolYear: schoolYear, termDescriptor: termDescriptor, evaluationTypeDescriptor: evaluationTypeDescriptor, evaluationObjectiveDescription: evaluationObjectiveDescription, id: id, maxRating: maxRating, minRating: minRating, sortOrder: sortOrder, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TpdmEvaluationObjective>') as List)
        .cast<TpdmEvaluationObjective>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getEvaluationObjectivesByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives/{id}'
      .replaceAll('{id}', id);
  ...
  Future<TpdmEvaluationObjective?> getEvaluationObjectivesById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getEvaluationObjectivesByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TpdmEvaluationObjective',) as TpdmEvaluationObjective;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getEvaluationObjectivesPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, String? evaluationObjectiveTitle, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? evaluationObjectiveDescription, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getEvaluationObjectivesPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, String? evaluationObjectiveTitle, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? evaluationObjectiveDescription, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    final response = await getEvaluationObjectivesPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, evaluationObjectiveTitle: evaluationObjectiveTitle, educationOrganizationId: educationOrganizationId, evaluationPeriodDescriptor: evaluationPeriodDescriptor, evaluationTitle: evaluationTitle, performanceEvaluationTitle: performanceEvaluationTitle, performanceEvaluationTypeDescriptor: performanceEvaluationTypeDescriptor, schoolYear: schoolYear, termDescriptor: termDescriptor, evaluationTypeDescriptor: evaluationTypeDescriptor, evaluationObjectiveDescription: evaluationObjectiveDescription, id: id, maxRating: maxRating, minRating: minRating, sortOrder: sortOrder, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesEvaluationObjectivesWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives/keyChanges';
  ...
  Future<List<TrackedChangesTpdmEvaluationObjectiveKeyChange>?> keyChangesEvaluationObjectives({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesEvaluationObjectivesWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmEvaluationObjectiveKeyChange>') as List)
        .cast<TrackedChangesTpdmEvaluationObjectiveKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [TpdmEvaluationObjective] tpdmEvaluationObjective (required):
  ///   The JSON representation of the \"evaluationObjective\" resource to be created or updated.
  Future<Response> postEvaluationObjectiveWithHttpInfo(TpdmEvaluationObjective tpdmEvaluationObjective,) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives';

    // ignore: prefer_final_locals
    Object? postBody = tpdmEvaluationObjective;
  ...
  /// * [TpdmEvaluationObjective] tpdmEvaluationObjective (required):
  ///   The JSON representation of the \"evaluationObjective\" resource to be created or updated.
  Future<void> postEvaluationObjective(TpdmEvaluationObjective tpdmEvaluationObjective,) async {
    final response = await postEvaluationObjectiveWithHttpInfo(tpdmEvaluationObjective,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putEvaluationObjectiveWithHttpInfo(String id, TpdmEvaluationObjective tpdmEvaluationObjective, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationObjectives/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putEvaluationObjective(String id, TpdmEvaluationObjective tpdmEvaluationObjective, { String? ifMatch, }) async {
    final response = await putEvaluationObjectiveWithHttpInfo(id, tpdmEvaluationObjective,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
