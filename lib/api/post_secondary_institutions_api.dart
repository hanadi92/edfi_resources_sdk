...
class PostSecondaryInstitutionsApi {
  PostSecondaryInstitutionsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deletePostSecondaryInstitutionByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deletePostSecondaryInstitutionById(String id, { String? ifMatch, }) async {
    final response = await deletePostSecondaryInstitutionByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesPostSecondaryInstitutionsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions/deletes';
  ...
  Future<List<TrackedChangesEdFiPostSecondaryInstitutionDelete>?> deletesPostSecondaryInstitutions({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesPostSecondaryInstitutionsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiPostSecondaryInstitutionDelete>') as List)
        .cast<TrackedChangesEdFiPostSecondaryInstitutionDelete>()
  ...
  Future<Response> getPostSecondaryInstitutionsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, int? postSecondaryInstitutionId, String? administrativeFundingControlDescriptor, String? postSecondaryInstitutionLevelDescriptor, String? operationalStatusDescriptor, String? id, String? nameOfInstitution, String? shortNameOfInstitution, String? webSite, bool? useSnapshot, String? educationOrganizationIdentificationSystemDescriptor, String? identificationCode, }) async {
    ...
    if (postSecondaryInstitutionId != null) {
      queryParams.addAll(_queryParams('', 'postSecondaryInstitutionId', postSecondaryInstitutionId));
    }
    ...
    if (postSecondaryInstitutionLevelDescriptor != null) {
      queryParams.addAll(_queryParams('', 'postSecondaryInstitutionLevelDescriptor', postSecondaryInstitutionLevelDescriptor));
    }
  ...
  Future<List<EdFiPostSecondaryInstitution>?> getPostSecondaryInstitutions({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, int? postSecondaryInstitutionId, String? administrativeFundingControlDescriptor, String? postSecondaryInstitutionLevelDescriptor, String? operationalStatusDescriptor, String? id, String? nameOfInstitution, String? shortNameOfInstitution, String? webSite, bool? useSnapshot, String? educationOrganizationIdentificationSystemDescriptor, String? identificationCode, }) async {
    final response = await getPostSecondaryInstitutionsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, postSecondaryInstitutionId: postSecondaryInstitutionId, administrativeFundingControlDescriptor: administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor: postSecondaryInstitutionLevelDescriptor, operationalStatusDescriptor: operationalStatusDescriptor, id: id, nameOfInstitution: nameOfInstitution, shortNameOfInstitution: shortNameOfInstitution, webSite: webSite, useSnapshot: useSnapshot, educationOrganizationIdentificationSystemDescriptor: educationOrganizationIdentificationSystemDescriptor, identificationCode: identificationCode, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiPostSecondaryInstitution>') as List)
        .cast<EdFiPostSecondaryInstitution>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getPostSecondaryInstitutionsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiPostSecondaryInstitution?> getPostSecondaryInstitutionsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getPostSecondaryInstitutionsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiPostSecondaryInstitution',) as EdFiPostSecondaryInstitution;
  ...
  /// * [String] identificationCode:
  ///   A unique number or alphanumeric code that is assigned to an education organization by a school, school system, state, or other agency or entity.
  Future<Response> getPostSecondaryInstitutionsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, int? postSecondaryInstitutionId, String? administrativeFundingControlDescriptor, String? postSecondaryInstitutionLevelDescriptor, String? operationalStatusDescriptor, String? id, String? nameOfInstitution, String? shortNameOfInstitution, String? webSite, bool? useSnapshot, String? educationOrganizationIdentificationSystemDescriptor, String? identificationCode, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getPostSecondaryInstitutionsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, int? postSecondaryInstitutionId, String? administrativeFundingControlDescriptor, String? postSecondaryInstitutionLevelDescriptor, String? operationalStatusDescriptor, String? id, String? nameOfInstitution, String? shortNameOfInstitution, String? webSite, bool? useSnapshot, String? educationOrganizationIdentificationSystemDescriptor, String? identificationCode, }) async {
    final response = await getPostSecondaryInstitutionsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, postSecondaryInstitutionId: postSecondaryInstitutionId, administrativeFundingControlDescriptor: administrativeFundingControlDescriptor, postSecondaryInstitutionLevelDescriptor: postSecondaryInstitutionLevelDescriptor, operationalStatusDescriptor: operationalStatusDescriptor, id: id, nameOfInstitution: nameOfInstitution, shortNameOfInstitution: shortNameOfInstitution, webSite: webSite, useSnapshot: useSnapshot, educationOrganizationIdentificationSystemDescriptor: educationOrganizationIdentificationSystemDescriptor, identificationCode: identificationCode, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesPostSecondaryInstitutionsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions/keyChanges';
  ...
  Future<List<TrackedChangesEdFiPostSecondaryInstitutionKeyChange>?> keyChangesPostSecondaryInstitutions({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesPostSecondaryInstitutionsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiPostSecondaryInstitutionKeyChange>') as List)
        .cast<TrackedChangesEdFiPostSecondaryInstitutionKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiPostSecondaryInstitution] edFiPostSecondaryInstitution (required):
  ///   The JSON representation of the \"postSecondaryInstitution\" resource to be created or updated.
  Future<Response> postPostSecondaryInstitutionWithHttpInfo(EdFiPostSecondaryInstitution edFiPostSecondaryInstitution,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions';

    // ignore: prefer_final_locals
    Object? postBody = edFiPostSecondaryInstitution;
  ...
  /// * [EdFiPostSecondaryInstitution] edFiPostSecondaryInstitution (required):
  ///   The JSON representation of the \"postSecondaryInstitution\" resource to be created or updated.
  Future<void> postPostSecondaryInstitution(EdFiPostSecondaryInstitution edFiPostSecondaryInstitution,) async {
    final response = await postPostSecondaryInstitutionWithHttpInfo(edFiPostSecondaryInstitution,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putPostSecondaryInstitutionWithHttpInfo(String id, EdFiPostSecondaryInstitution edFiPostSecondaryInstitution, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/postSecondaryInstitutions/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putPostSecondaryInstitution(String id, EdFiPostSecondaryInstitution edFiPostSecondaryInstitution, { String? ifMatch, }) async {
    final response = await putPostSecondaryInstitutionWithHttpInfo(id, edFiPostSecondaryInstitution,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
