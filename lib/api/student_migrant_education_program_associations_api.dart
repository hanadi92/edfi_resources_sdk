...
class StudentMigrantEducationProgramAssociationsApi {
  StudentMigrantEducationProgramAssociationsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteStudentMigrantEducationProgramAssociationByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/studentMigrantEducationProgramAssociations/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteStudentMigrantEducationProgramAssociationById(String id, { String? ifMatch, }) async {
    final response = await deleteStudentMigrantEducationProgramAssociationByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesStudentMigrantEducationProgramAssociationsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/studentMigrantEducationProgramAssociations/deletes';
  ...
  Future<List<TrackedChangesEdFiStudentMigrantEducationProgramAssociationDelete>?> deletesStudentMigrantEducationProgramAssociations({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesStudentMigrantEducationProgramAssociationsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiStudentMigrantEducationProgramAssociationDelete>') as List)
        .cast<TrackedChangesEdFiStudentMigrantEducationProgramAssociationDelete>()
  ...
  Future<Response> getStudentMigrantEducationProgramAssociationsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, DateTime? beginDate, int? educationOrganizationId, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, String? studentUniqueId, String? continuationOfServicesReasonDescriptor, DateTime? eligibilityExpirationDate, DateTime? lastQualifyingMove, bool? priorityForServices, DateTime? qualifyingArrivalDate, DateTime? stateResidencyDate, DateTime? usInitialEntry, DateTime? usInitialSchoolEntry, DateTime? usMostRecentEntry, String? reasonExitedDescriptor, DateTime? endDate, String? id, bool? servedOutsideOfRegularSession, bool? useSnapshot, }) async {
    ...
    if (continuationOfServicesReasonDescriptor != null) {
      queryParams.addAll(_queryParams('', 'continuationOfServicesReasonDescriptor', continuationOfServicesReasonDescriptor));
    }
    if (eligibilityExpirationDate != null) {
      queryParams.addAll(_queryParams('', 'eligibilityExpirationDate', eligibilityExpirationDate));
    }
    if (lastQualifyingMove != null) {
      queryParams.addAll(_queryParams('', 'lastQualifyingMove', lastQualifyingMove));
    }
    if (priorityForServices != null) {
      queryParams.addAll(_queryParams('', 'priorityForServices', priorityForServices));
    }
    if (qualifyingArrivalDate != null) {
      queryParams.addAll(_queryParams('', 'qualifyingArrivalDate', qualifyingArrivalDate));
    }
    if (stateResidencyDate != null) {
      queryParams.addAll(_queryParams('', 'stateResidencyDate', stateResidencyDate));
    }
    if (usInitialEntry != null) {
      queryParams.addAll(_queryParams('', 'usInitialEntry', usInitialEntry));
    }
    if (usInitialSchoolEntry != null) {
      queryParams.addAll(_queryParams('', 'usInitialSchoolEntry', usInitialSchoolEntry));
    }
    if (usMostRecentEntry != null) {
      queryParams.addAll(_queryParams('', 'usMostRecentEntry', usMostRecentEntry));
    }
  ...
  Future<List<EdFiStudentMigrantEducationProgramAssociation>?> getStudentMigrantEducationProgramAssociations({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, DateTime? beginDate, int? educationOrganizationId, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, String? studentUniqueId, String? continuationOfServicesReasonDescriptor, DateTime? eligibilityExpirationDate, DateTime? lastQualifyingMove, bool? priorityForServices, DateTime? qualifyingArrivalDate, DateTime? stateResidencyDate, DateTime? usInitialEntry, DateTime? usInitialSchoolEntry, DateTime? usMostRecentEntry, String? reasonExitedDescriptor, DateTime? endDate, String? id, bool? servedOutsideOfRegularSession, bool? useSnapshot, }) async {
    final response = await getStudentMigrantEducationProgramAssociationsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, beginDate: beginDate, educationOrganizationId: educationOrganizationId, programEducationOrganizationId: programEducationOrganizationId, programName: programName, programTypeDescriptor: programTypeDescriptor, studentUniqueId: studentUniqueId, continuationOfServicesReasonDescriptor: continuationOfServicesReasonDescriptor, eligibilityExpirationDate: eligibilityExpirationDate, lastQualifyingMove: lastQualifyingMove, priorityForServices: priorityForServices, qualifyingArrivalDate: qualifyingArrivalDate, stateResidencyDate: stateResidencyDate, usInitialEntry: usInitialEntry, usInitialSchoolEntry: usInitialSchoolEntry, usMostRecentEntry: usMostRecentEntry, reasonExitedDescriptor: reasonExitedDescriptor, endDate: endDate, id: id, servedOutsideOfRegularSession: servedOutsideOfRegularSession, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiStudentMigrantEducationProgramAssociation>') as List)
        .cast<EdFiStudentMigrantEducationProgramAssociation>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getStudentMigrantEducationProgramAssociationsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/studentMigrantEducationProgramAssociations/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiStudentMigrantEducationProgramAssociation?> getStudentMigrantEducationProgramAssociationsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getStudentMigrantEducationProgramAssociationsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiStudentMigrantEducationProgramAssociation',) as EdFiStudentMigrantEducationProgramAssociation;
  ...
  Future<GetAcademicWeeksPartitions200Response?> getStudentMigrantEducationProgramAssociationsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, DateTime? beginDate, int? educationOrganizationId, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, String? studentUniqueId, String? continuationOfServicesReasonDescriptor, DateTime? eligibilityExpirationDate, DateTime? lastQualifyingMove, bool? priorityForServices, DateTime? qualifyingArrivalDate, DateTime? stateResidencyDate, DateTime? usInitialEntry, DateTime? usInitialSchoolEntry, DateTime? usMostRecentEntry, String? reasonExitedDescriptor, DateTime? endDate, String? id, bool? servedOutsideOfRegularSession, bool? useSnapshot, }) async {
    final response = await getStudentMigrantEducationProgramAssociationsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, beginDate: beginDate, educationOrganizationId: educationOrganizationId, programEducationOrganizationId: programEducationOrganizationId, programName: programName, programTypeDescriptor: programTypeDescriptor, studentUniqueId: studentUniqueId, continuationOfServicesReasonDescriptor: continuationOfServicesReasonDescriptor, eligibilityExpirationDate: eligibilityExpirationDate, lastQualifyingMove: lastQualifyingMove, priorityForServices: priorityForServices, qualifyingArrivalDate: qualifyingArrivalDate, stateResidencyDate: stateResidencyDate, usInitialEntry: usInitialEntry, usInitialSchoolEntry: usInitialSchoolEntry, usMostRecentEntry: usMostRecentEntry, reasonExitedDescriptor: reasonExitedDescriptor, endDate: endDate, id: id, servedOutsideOfRegularSession: servedOutsideOfRegularSession, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesStudentMigrantEducationProgramAssociationsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/studentMigrantEducationProgramAssociations/keyChanges';
  ...
  Future<List<TrackedChangesEdFiStudentMigrantEducationProgramAssociationKeyChange>?> keyChangesStudentMigrantEducationProgramAssociations({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesStudentMigrantEducationProgramAssociationsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiStudentMigrantEducationProgramAssociationKeyChange>') as List)
        .cast<TrackedChangesEdFiStudentMigrantEducationProgramAssociationKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiStudentMigrantEducationProgramAssociation] edFiStudentMigrantEducationProgramAssociation (required):
  ///   The JSON representation of the \"studentMigrantEducationProgramAssociation\" resource to be created or updated.
  Future<Response> postStudentMigrantEducationProgramAssociationWithHttpInfo(EdFiStudentMigrantEducationProgramAssociation edFiStudentMigrantEducationProgramAssociation,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/studentMigrantEducationProgramAssociations';

    // ignore: prefer_final_locals
    Object? postBody = edFiStudentMigrantEducationProgramAssociation;
  ...
  /// * [EdFiStudentMigrantEducationProgramAssociation] edFiStudentMigrantEducationProgramAssociation (required):
  ///   The JSON representation of the \"studentMigrantEducationProgramAssociation\" resource to be created or updated.
  Future<void> postStudentMigrantEducationProgramAssociation(EdFiStudentMigrantEducationProgramAssociation edFiStudentMigrantEducationProgramAssociation,) async {
    final response = await postStudentMigrantEducationProgramAssociationWithHttpInfo(edFiStudentMigrantEducationProgramAssociation,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putStudentMigrantEducationProgramAssociationWithHttpInfo(String id, EdFiStudentMigrantEducationProgramAssociation edFiStudentMigrantEducationProgramAssociation, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/studentMigrantEducationProgramAssociations/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putStudentMigrantEducationProgramAssociation(String id, EdFiStudentMigrantEducationProgramAssociation edFiStudentMigrantEducationProgramAssociation, { String? ifMatch, }) async {
    final response = await putStudentMigrantEducationProgramAssociationWithHttpInfo(id, edFiStudentMigrantEducationProgramAssociation,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
