...
class EvaluationElementsApi {
  EvaluationElementsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteEvaluationElementByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteEvaluationElementById(String id, { String? ifMatch, }) async {
    final response = await deleteEvaluationElementByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesEvaluationElementsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements/deletes';
  ...
  Future<List<TrackedChangesTpdmEvaluationElementDelete>?> deletesEvaluationElements({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesEvaluationElementsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmEvaluationElementDelete>') as List)
        .cast<TrackedChangesTpdmEvaluationElementDelete>()
  ...
  Future<List<TpdmEvaluationElement>?> getEvaluationElements({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? evaluationElementTitle, int? educationOrganizationId, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TpdmEvaluationElement>') as List)
        .cast<TpdmEvaluationElement>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getEvaluationElementsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements/{id}'
      .replaceAll('{id}', id);
  ...
  Future<TpdmEvaluationElement?> getEvaluationElementsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getEvaluationElementsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TpdmEvaluationElement',) as TpdmEvaluationElement;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getEvaluationElementsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, String? evaluationElementTitle, int? educationOrganizationId, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getEvaluationElementsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, String? evaluationElementTitle, int? educationOrganizationId, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? evaluationTypeDescriptor, String? id, double? maxRating, double? minRating, int? sortOrder, bool? useSnapshot, }) async {
    final response = await getEvaluationElementsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, evaluationElementTitle: evaluationElementTitle, educationOrganizationId: educationOrganizationId, evaluationObjectiveTitle: evaluationObjectiveTitle, evaluationPeriodDescriptor: evaluationPeriodDescriptor, evaluationTitle: evaluationTitle, performanceEvaluationTitle: performanceEvaluationTitle, performanceEvaluationTypeDescriptor: performanceEvaluationTypeDescriptor, schoolYear: schoolYear, termDescriptor: termDescriptor, evaluationTypeDescriptor: evaluationTypeDescriptor, id: id, maxRating: maxRating, minRating: minRating, sortOrder: sortOrder, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesEvaluationElementsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements/keyChanges';
  ...
  Future<List<TrackedChangesTpdmEvaluationElementKeyChange>?> keyChangesEvaluationElements({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesEvaluationElementsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmEvaluationElementKeyChange>') as List)
        .cast<TrackedChangesTpdmEvaluationElementKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [TpdmEvaluationElement] tpdmEvaluationElement (required):
  ///   The JSON representation of the \"evaluationElement\" resource to be created or updated.
  Future<Response> postEvaluationElementWithHttpInfo(TpdmEvaluationElement tpdmEvaluationElement,) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements';

    // ignore: prefer_final_locals
    Object? postBody = tpdmEvaluationElement;
  ...
  /// * [TpdmEvaluationElement] tpdmEvaluationElement (required):
  ///   The JSON representation of the \"evaluationElement\" resource to be created or updated.
  Future<void> postEvaluationElement(TpdmEvaluationElement tpdmEvaluationElement,) async {
    final response = await postEvaluationElementWithHttpInfo(tpdmEvaluationElement,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putEvaluationElementWithHttpInfo(String id, TpdmEvaluationElement tpdmEvaluationElement, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElements/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putEvaluationElement(String id, TpdmEvaluationElement tpdmEvaluationElement, { String? ifMatch, }) async {
    final response = await putEvaluationElementWithHttpInfo(id, tpdmEvaluationElement,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
