...
class ProgramsApi {
  ...
  Future<Response> deleteProgramByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteProgramById(String id, { String? ifMatch, }) async {
    final response = await deleteProgramByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesProgramsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs/deletes';
  ...
  Future<List<TrackedChangesEdFiProgramDelete>?> deletesPrograms({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesProgramsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiProgramDelete>') as List)
        .cast<TrackedChangesEdFiProgramDelete>()
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? programTypeDescriptor, String? programName, int? educationOrganizationId, String? id, String? programId, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs';
  ...
  Future<List<EdFiProgram>?> getPrograms({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? programTypeDescriptor, String? programName, int? educationOrganizationId, String? id, String? programId, bool? useSnapshot, }) async {
    final response = await getProgramsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, programTypeDescriptor: programTypeDescriptor, programName: programName, educationOrganizationId: educationOrganizationId, id: id, programId: programId, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiProgram>') as List)
        .cast<EdFiProgram>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiProgram?> getProgramsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getProgramsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiProgram',) as EdFiProgram;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, String? programTypeDescriptor, String? programName, int? educationOrganizationId, String? id, String? programId, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getProgramsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, String? programTypeDescriptor, String? programName, int? educationOrganizationId, String? id, String? programId, bool? useSnapshot, }) async {
    final response = await getProgramsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, programTypeDescriptor: programTypeDescriptor, programName: programName, educationOrganizationId: educationOrganizationId, id: id, programId: programId, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesProgramsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs/keyChanges';
  ...
  Future<List<TrackedChangesEdFiProgramKeyChange>?> keyChangesPrograms({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesProgramsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiProgramKeyChange>') as List)
        .cast<TrackedChangesEdFiProgramKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiProgram] edFiProgram (required):
  ///   The JSON representation of the \"program\" resource to be created or updated.
  Future<Response> postProgramWithHttpInfo(EdFiProgram edFiProgram,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs';

    // ignore: prefer_final_locals
    Object? postBody = edFiProgram;
  ...
  /// * [EdFiProgram] edFiProgram (required):
  ///   The JSON representation of the \"program\" resource to be created or updated.
  Future<void> postProgram(EdFiProgram edFiProgram,) async {
    final response = await postProgramWithHttpInfo(edFiProgram,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putProgramWithHttpInfo(String id, EdFiProgram edFiProgram, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programs/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putProgram(String id, EdFiProgram edFiProgram, { String? ifMatch, }) async {
    final response = await putProgramWithHttpInfo(id, edFiProgram,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
