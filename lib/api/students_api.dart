...
class StudentsApi {
  ...
  Future<Response> deleteStudentByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteStudentById(String id, { String? ifMatch, }) async {
    final response = await deleteStudentByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesStudentsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students/deletes';
  ...
  Future<List<TrackedChangesEdFiStudentDelete>?> deletesStudents({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesStudentsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiStudentDelete>') as List)
        .cast<TrackedChangesEdFiStudentDelete>()
  ...
  Future<List<EdFiStudent>?> getStudents({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? studentUniqueId, String? personId, String? sourceSystemDescriptor, String? citizenshipStatusDescriptor, String? birthCountryDescriptor, String? birthSexDescriptor, String? birthStateAbbreviationDescriptor, String? birthCity, DateTime? birthDate, String? birthInternationalProvince, DateTime? dateEnteredUS, String? firstName, String? generationCodeSuffix, String? id, String? lastSurname, String? maidenName, String? middleName, bool? multipleBirthStatus, String? personalTitlePrefix, String? preferredFirstName, String? preferredLastSurname, bool? useSnapshot, }) async {
    final response = await getStudentsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, studentUniqueId: studentUniqueId, personId: personId, sourceSystemDescriptor: sourceSystemDescriptor, citizenshipStatusDescriptor: citizenshipStatusDescriptor, birthCountryDescriptor: birthCountryDescriptor, birthSexDescriptor: birthSexDescriptor, birthStateAbbreviationDescriptor: birthStateAbbreviationDescriptor, birthCity: birthCity, birthDate: birthDate, birthInternationalProvince: birthInternationalProvince, dateEnteredUS: dateEnteredUS, firstName: firstName, generationCodeSuffix: generationCodeSuffix, id: id, lastSurname: lastSurname, maidenName: maidenName, middleName: middleName, multipleBirthStatus: multipleBirthStatus, personalTitlePrefix: personalTitlePrefix, preferredFirstName: preferredFirstName, preferredLastSurname: preferredLastSurname, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiStudent>') as List)
        .cast<EdFiStudent>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getStudentsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiStudent?> getStudentsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getStudentsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiStudent',) as EdFiStudent;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getStudentsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, String? studentUniqueId, String? personId, String? sourceSystemDescriptor, String? citizenshipStatusDescriptor, String? birthCountryDescriptor, String? birthSexDescriptor, String? birthStateAbbreviationDescriptor, String? birthCity, DateTime? birthDate, String? birthInternationalProvince, DateTime? dateEnteredUS, String? firstName, String? generationCodeSuffix, String? id, String? lastSurname, String? maidenName, String? middleName, bool? multipleBirthStatus, String? personalTitlePrefix, String? preferredFirstName, String? preferredLastSurname, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getStudentsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, String? studentUniqueId, String? personId, String? sourceSystemDescriptor, String? citizenshipStatusDescriptor, String? birthCountryDescriptor, String? birthSexDescriptor, String? birthStateAbbreviationDescriptor, String? birthCity, DateTime? birthDate, String? birthInternationalProvince, DateTime? dateEnteredUS, String? firstName, String? generationCodeSuffix, String? id, String? lastSurname, String? maidenName, String? middleName, bool? multipleBirthStatus, String? personalTitlePrefix, String? preferredFirstName, String? preferredLastSurname, bool? useSnapshot, }) async {
    final response = await getStudentsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, studentUniqueId: studentUniqueId, personId: personId, sourceSystemDescriptor: sourceSystemDescriptor, citizenshipStatusDescriptor: citizenshipStatusDescriptor, birthCountryDescriptor: birthCountryDescriptor, birthSexDescriptor: birthSexDescriptor, birthStateAbbreviationDescriptor: birthStateAbbreviationDescriptor, birthCity: birthCity, birthDate: birthDate, birthInternationalProvince: birthInternationalProvince, dateEnteredUS: dateEnteredUS, firstName: firstName, generationCodeSuffix: generationCodeSuffix, id: id, lastSurname: lastSurname, maidenName: maidenName, middleName: middleName, multipleBirthStatus: multipleBirthStatus, personalTitlePrefix: personalTitlePrefix, preferredFirstName: preferredFirstName, preferredLastSurname: preferredLastSurname, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesStudentsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students/keyChanges';
  ...
  Future<List<TrackedChangesEdFiStudentKeyChange>?> keyChangesStudents({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesStudentsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiStudentKeyChange>') as List)
        .cast<TrackedChangesEdFiStudentKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiStudent] edFiStudent (required):
  ///   The JSON representation of the \"student\" resource to be created or updated.
  Future<Response> postStudentWithHttpInfo(EdFiStudent edFiStudent,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students';

    // ignore: prefer_final_locals
    Object? postBody = edFiStudent;
  ...
  /// * [EdFiStudent] edFiStudent (required):
  ///   The JSON representation of the \"student\" resource to be created or updated.
  Future<void> postStudent(EdFiStudent edFiStudent,) async {
    final response = await postStudentWithHttpInfo(edFiStudent,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putStudentWithHttpInfo(String id, EdFiStudent edFiStudent, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/students/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putStudent(String id, EdFiStudent edFiStudent, { String? ifMatch, }) async {
    final response = await putStudentWithHttpInfo(id, edFiStudent,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
