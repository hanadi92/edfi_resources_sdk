...
class ProgramEvaluationObjectivesApi {
  ProgramEvaluationObjectivesApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteProgramEvaluationObjectiveByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteProgramEvaluationObjectiveById(String id, { String? ifMatch, }) async {
    final response = await deleteProgramEvaluationObjectiveByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesProgramEvaluationObjectivesWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives/deletes';
  ...
  Future<List<TrackedChangesEdFiProgramEvaluationObjectiveDelete>?> deletesProgramEvaluationObjectives({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesProgramEvaluationObjectivesWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiProgramEvaluationObjectiveDelete>') as List)
        .cast<TrackedChangesEdFiProgramEvaluationObjectiveDelete>()
  ...
  Future<Response> getProgramEvaluationObjectivesWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? programEvaluationObjectiveTitle, int? programEducationOrganizationId, String? programEvaluationPeriodDescriptor, String? programEvaluationTitle, String? programEvaluationTypeDescriptor, String? programName, String? programTypeDescriptor, String? id, double? objectiveMaxNumericRating, double? objectiveMinNumericRating, int? objectiveSortOrder, String? programEvaluationObjectiveDescription, bool? useSnapshot, }) async {
    ...
    if (objectiveMaxNumericRating != null) {
      queryParams.addAll(_queryParams('', 'objectiveMaxNumericRating', objectiveMaxNumericRating));
    }
    if (objectiveMinNumericRating != null) {
      queryParams.addAll(_queryParams('', 'objectiveMinNumericRating', objectiveMinNumericRating));
    }
    if (objectiveSortOrder != null) {
      queryParams.addAll(_queryParams('', 'objectiveSortOrder', objectiveSortOrder));
    }
    if (programEvaluationObjectiveDescription != null) {
      queryParams.addAll(_queryParams('', 'programEvaluationObjectiveDescription', programEvaluationObjectiveDescription));
    }
  ...
  Future<List<EdFiProgramEvaluationObjective>?> getProgramEvaluationObjectives({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? programEvaluationObjectiveTitle, int? programEducationOrganizationId, String? programEvaluationPeriodDescriptor, String? programEvaluationTitle, String? programEvaluationTypeDescriptor, String? programName, String? programTypeDescriptor, String? id, double? objectiveMaxNumericRating, double? objectiveMinNumericRating, int? objectiveSortOrder, String? programEvaluationObjectiveDescription, bool? useSnapshot, }) async {
    final response = await getProgramEvaluationObjectivesWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, programEvaluationObjectiveTitle: programEvaluationObjectiveTitle, programEducationOrganizationId: programEducationOrganizationId, programEvaluationPeriodDescriptor: programEvaluationPeriodDescriptor, programEvaluationTitle: programEvaluationTitle, programEvaluationTypeDescriptor: programEvaluationTypeDescriptor, programName: programName, programTypeDescriptor: programTypeDescriptor, id: id, objectiveMaxNumericRating: objectiveMaxNumericRating, objectiveMinNumericRating: objectiveMinNumericRating, objectiveSortOrder: objectiveSortOrder, programEvaluationObjectiveDescription: programEvaluationObjectiveDescription, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiProgramEvaluationObjective>') as List)
        .cast<EdFiProgramEvaluationObjective>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramEvaluationObjectivesByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiProgramEvaluationObjective?> getProgramEvaluationObjectivesById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getProgramEvaluationObjectivesByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiProgramEvaluationObjective',) as EdFiProgramEvaluationObjective;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramEvaluationObjectivesPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, String? programEvaluationObjectiveTitle, int? programEducationOrganizationId, String? programEvaluationPeriodDescriptor, String? programEvaluationTitle, String? programEvaluationTypeDescriptor, String? programName, String? programTypeDescriptor, String? id, double? objectiveMaxNumericRating, double? objectiveMinNumericRating, int? objectiveSortOrder, String? programEvaluationObjectiveDescription, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getProgramEvaluationObjectivesPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, String? programEvaluationObjectiveTitle, int? programEducationOrganizationId, String? programEvaluationPeriodDescriptor, String? programEvaluationTitle, String? programEvaluationTypeDescriptor, String? programName, String? programTypeDescriptor, String? id, double? objectiveMaxNumericRating, double? objectiveMinNumericRating, int? objectiveSortOrder, String? programEvaluationObjectiveDescription, bool? useSnapshot, }) async {
    final response = await getProgramEvaluationObjectivesPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, programEvaluationObjectiveTitle: programEvaluationObjectiveTitle, programEducationOrganizationId: programEducationOrganizationId, programEvaluationPeriodDescriptor: programEvaluationPeriodDescriptor, programEvaluationTitle: programEvaluationTitle, programEvaluationTypeDescriptor: programEvaluationTypeDescriptor, programName: programName, programTypeDescriptor: programTypeDescriptor, id: id, objectiveMaxNumericRating: objectiveMaxNumericRating, objectiveMinNumericRating: objectiveMinNumericRating, objectiveSortOrder: objectiveSortOrder, programEvaluationObjectiveDescription: programEvaluationObjectiveDescription, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesProgramEvaluationObjectivesWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives/keyChanges';
  ...
  Future<List<TrackedChangesEdFiProgramEvaluationObjectiveKeyChange>?> keyChangesProgramEvaluationObjectives({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesProgramEvaluationObjectivesWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiProgramEvaluationObjectiveKeyChange>') as List)
        .cast<TrackedChangesEdFiProgramEvaluationObjectiveKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiProgramEvaluationObjective] edFiProgramEvaluationObjective (required):
  ///   The JSON representation of the \"programEvaluationObjective\" resource to be created or updated.
  Future<Response> postProgramEvaluationObjectiveWithHttpInfo(EdFiProgramEvaluationObjective edFiProgramEvaluationObjective,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives';

    // ignore: prefer_final_locals
    Object? postBody = edFiProgramEvaluationObjective;
  ...
  /// * [EdFiProgramEvaluationObjective] edFiProgramEvaluationObjective (required):
  ///   The JSON representation of the \"programEvaluationObjective\" resource to be created or updated.
  Future<void> postProgramEvaluationObjective(EdFiProgramEvaluationObjective edFiProgramEvaluationObjective,) async {
    final response = await postProgramEvaluationObjectiveWithHttpInfo(edFiProgramEvaluationObjective,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putProgramEvaluationObjectiveWithHttpInfo(String id, EdFiProgramEvaluationObjective edFiProgramEvaluationObjective, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluationObjectives/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putProgramEvaluationObjective(String id, EdFiProgramEvaluationObjective edFiProgramEvaluationObjective, { String? ifMatch, }) async {
    final response = await putProgramEvaluationObjectiveWithHttpInfo(id, edFiProgramEvaluationObjective,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
