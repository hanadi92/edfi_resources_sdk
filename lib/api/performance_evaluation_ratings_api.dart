...
class PerformanceEvaluationRatingsApi {
  PerformanceEvaluationRatingsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deletePerformanceEvaluationRatingByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deletePerformanceEvaluationRatingById(String id, { String? ifMatch, }) async {
    final response = await deletePerformanceEvaluationRatingByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesPerformanceEvaluationRatingsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings/deletes';
  ...
  Future<List<TrackedChangesTpdmPerformanceEvaluationRatingDelete>?> deletesPerformanceEvaluationRatings({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesPerformanceEvaluationRatingsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmPerformanceEvaluationRatingDelete>') as List)
        .cast<TrackedChangesTpdmPerformanceEvaluationRatingDelete>()
  ...
  Future<Response> getPerformanceEvaluationRatingsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? personId, String? sourceSystemDescriptor, String? coteachingStyleObservedDescriptor, String? performanceEvaluationRatingLevelDescriptor, DateTime? actualDate, int? actualDuration, String? actualTime, bool? announced, String? comments, String? id, DateTime? scheduleDate, bool? useSnapshot, }) async {
    ...
    if (coteachingStyleObservedDescriptor != null) {
      queryParams.addAll(_queryParams('', 'coteachingStyleObservedDescriptor', coteachingStyleObservedDescriptor));
    }
    if (performanceEvaluationRatingLevelDescriptor != null) {
      queryParams.addAll(_queryParams('', 'performanceEvaluationRatingLevelDescriptor', performanceEvaluationRatingLevelDescriptor));
    }
    if (actualDate != null) {
      queryParams.addAll(_queryParams('', 'actualDate', actualDate));
    }
    if (actualDuration != null) {
      queryParams.addAll(_queryParams('', 'actualDuration', actualDuration));
    }
    if (actualTime != null) {
      queryParams.addAll(_queryParams('', 'actualTime', actualTime));
    }
    if (announced != null) {
      queryParams.addAll(_queryParams('', 'announced', announced));
    }
    if (comments != null) {
    ...
    if (scheduleDate != null) {
      queryParams.addAll(_queryParams('', 'scheduleDate', scheduleDate));
    }
  ...
  Future<List<TpdmPerformanceEvaluationRating>?> getPerformanceEvaluationRatings({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? personId, String? sourceSystemDescriptor, String? coteachingStyleObservedDescriptor, String? performanceEvaluationRatingLevelDescriptor, DateTime? actualDate, int? actualDuration, String? actualTime, bool? announced, String? comments, String? id, DateTime? scheduleDate, bool? useSnapshot, }) async {
    final response = await getPerformanceEvaluationRatingsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, educationOrganizationId: educationOrganizationId, evaluationPeriodDescriptor: evaluationPeriodDescriptor, performanceEvaluationTitle: performanceEvaluationTitle, performanceEvaluationTypeDescriptor: performanceEvaluationTypeDescriptor, schoolYear: schoolYear, termDescriptor: termDescriptor, personId: personId, sourceSystemDescriptor: sourceSystemDescriptor, coteachingStyleObservedDescriptor: coteachingStyleObservedDescriptor, performanceEvaluationRatingLevelDescriptor: performanceEvaluationRatingLevelDescriptor, actualDate: actualDate, actualDuration: actualDuration, actualTime: actualTime, announced: announced, comments: comments, id: id, scheduleDate: scheduleDate, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TpdmPerformanceEvaluationRating>') as List)
        .cast<TpdmPerformanceEvaluationRating>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getPerformanceEvaluationRatingsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings/{id}'
      .replaceAll('{id}', id);
  ...
  Future<TpdmPerformanceEvaluationRating?> getPerformanceEvaluationRatingsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getPerformanceEvaluationRatingsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TpdmPerformanceEvaluationRating',) as TpdmPerformanceEvaluationRating;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getPerformanceEvaluationRatingsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? personId, String? sourceSystemDescriptor, String? coteachingStyleObservedDescriptor, String? performanceEvaluationRatingLevelDescriptor, DateTime? actualDate, int? actualDuration, String? actualTime, bool? announced, String? comments, String? id, DateTime? scheduleDate, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getPerformanceEvaluationRatingsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, int? educationOrganizationId, String? evaluationPeriodDescriptor, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, String? personId, String? sourceSystemDescriptor, String? coteachingStyleObservedDescriptor, String? performanceEvaluationRatingLevelDescriptor, DateTime? actualDate, int? actualDuration, String? actualTime, bool? announced, String? comments, String? id, DateTime? scheduleDate, bool? useSnapshot, }) async {
    final response = await getPerformanceEvaluationRatingsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, educationOrganizationId: educationOrganizationId, evaluationPeriodDescriptor: evaluationPeriodDescriptor, performanceEvaluationTitle: performanceEvaluationTitle, performanceEvaluationTypeDescriptor: performanceEvaluationTypeDescriptor, schoolYear: schoolYear, termDescriptor: termDescriptor, personId: personId, sourceSystemDescriptor: sourceSystemDescriptor, coteachingStyleObservedDescriptor: coteachingStyleObservedDescriptor, performanceEvaluationRatingLevelDescriptor: performanceEvaluationRatingLevelDescriptor, actualDate: actualDate, actualDuration: actualDuration, actualTime: actualTime, announced: announced, comments: comments, id: id, scheduleDate: scheduleDate, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesPerformanceEvaluationRatingsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings/keyChanges';
  ...
  Future<List<TrackedChangesTpdmPerformanceEvaluationRatingKeyChange>?> keyChangesPerformanceEvaluationRatings({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesPerformanceEvaluationRatingsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmPerformanceEvaluationRatingKeyChange>') as List)
        .cast<TrackedChangesTpdmPerformanceEvaluationRatingKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [TpdmPerformanceEvaluationRating] tpdmPerformanceEvaluationRating (required):
  ///   The JSON representation of the \"performanceEvaluationRating\" resource to be created or updated.
  Future<Response> postPerformanceEvaluationRatingWithHttpInfo(TpdmPerformanceEvaluationRating tpdmPerformanceEvaluationRating,) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings';

    // ignore: prefer_final_locals
    Object? postBody = tpdmPerformanceEvaluationRating;
  ...
  /// * [TpdmPerformanceEvaluationRating] tpdmPerformanceEvaluationRating (required):
  ///   The JSON representation of the \"performanceEvaluationRating\" resource to be created or updated.
  Future<void> postPerformanceEvaluationRating(TpdmPerformanceEvaluationRating tpdmPerformanceEvaluationRating,) async {
    final response = await postPerformanceEvaluationRatingWithHttpInfo(tpdmPerformanceEvaluationRating,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putPerformanceEvaluationRatingWithHttpInfo(String id, TpdmPerformanceEvaluationRating tpdmPerformanceEvaluationRating, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/performanceEvaluationRatings/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putPerformanceEvaluationRating(String id, TpdmPerformanceEvaluationRating tpdmPerformanceEvaluationRating, { String? ifMatch, }) async {
    final response = await putPerformanceEvaluationRatingWithHttpInfo(id, tpdmPerformanceEvaluationRating,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
