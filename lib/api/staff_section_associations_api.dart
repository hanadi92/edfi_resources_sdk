...
class StaffSectionAssociationsApi {
  StaffSectionAssociationsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteStaffSectionAssociationByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteStaffSectionAssociationById(String id, { String? ifMatch, }) async {
    final response = await deleteStaffSectionAssociationByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesStaffSectionAssociationsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations/deletes';
  ...
  Future<List<TrackedChangesEdFiStaffSectionAssociationDelete>?> deletesStaffSectionAssociations({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesStaffSectionAssociationsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiStaffSectionAssociationDelete>') as List)
        .cast<TrackedChangesEdFiStaffSectionAssociationDelete>()
  ...
  Future<Response> getStaffSectionAssociationsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, DateTime? beginDate, String? localCourseCode, int? schoolId, int? schoolYear, String? sectionIdentifier, String? sessionName, String? staffUniqueId, String? classroomPositionDescriptor, DateTime? endDate, bool? highlyQualifiedTeacher, String? id, double? percentageContribution, bool? teacherStudentDataLinkExclusion, bool? useSnapshot, }) async {
    ...
    if (classroomPositionDescriptor != null) {
      queryParams.addAll(_queryParams('', 'classroomPositionDescriptor', classroomPositionDescriptor));
    }
    if (endDate != null) {
    ...
    if (percentageContribution != null) {
      queryParams.addAll(_queryParams('', 'percentageContribution', percentageContribution));
    }
  ...
  Future<List<EdFiStaffSectionAssociation>?> getStaffSectionAssociations({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, DateTime? beginDate, String? localCourseCode, int? schoolId, int? schoolYear, String? sectionIdentifier, String? sessionName, String? staffUniqueId, String? classroomPositionDescriptor, DateTime? endDate, bool? highlyQualifiedTeacher, String? id, double? percentageContribution, bool? teacherStudentDataLinkExclusion, bool? useSnapshot, }) async {
    final response = await getStaffSectionAssociationsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, beginDate: beginDate, localCourseCode: localCourseCode, schoolId: schoolId, schoolYear: schoolYear, sectionIdentifier: sectionIdentifier, sessionName: sessionName, staffUniqueId: staffUniqueId, classroomPositionDescriptor: classroomPositionDescriptor, endDate: endDate, highlyQualifiedTeacher: highlyQualifiedTeacher, id: id, percentageContribution: percentageContribution, teacherStudentDataLinkExclusion: teacherStudentDataLinkExclusion, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiStaffSectionAssociation>') as List)
        .cast<EdFiStaffSectionAssociation>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getStaffSectionAssociationsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiStaffSectionAssociation?> getStaffSectionAssociationsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getStaffSectionAssociationsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiStaffSectionAssociation',) as EdFiStaffSectionAssociation;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getStaffSectionAssociationsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, DateTime? beginDate, String? localCourseCode, int? schoolId, int? schoolYear, String? sectionIdentifier, String? sessionName, String? staffUniqueId, String? classroomPositionDescriptor, DateTime? endDate, bool? highlyQualifiedTeacher, String? id, double? percentageContribution, bool? teacherStudentDataLinkExclusion, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getStaffSectionAssociationsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, DateTime? beginDate, String? localCourseCode, int? schoolId, int? schoolYear, String? sectionIdentifier, String? sessionName, String? staffUniqueId, String? classroomPositionDescriptor, DateTime? endDate, bool? highlyQualifiedTeacher, String? id, double? percentageContribution, bool? teacherStudentDataLinkExclusion, bool? useSnapshot, }) async {
    final response = await getStaffSectionAssociationsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, beginDate: beginDate, localCourseCode: localCourseCode, schoolId: schoolId, schoolYear: schoolYear, sectionIdentifier: sectionIdentifier, sessionName: sessionName, staffUniqueId: staffUniqueId, classroomPositionDescriptor: classroomPositionDescriptor, endDate: endDate, highlyQualifiedTeacher: highlyQualifiedTeacher, id: id, percentageContribution: percentageContribution, teacherStudentDataLinkExclusion: teacherStudentDataLinkExclusion, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesStaffSectionAssociationsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations/keyChanges';
  ...
  Future<List<TrackedChangesEdFiStaffSectionAssociationKeyChange>?> keyChangesStaffSectionAssociations({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesStaffSectionAssociationsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiStaffSectionAssociationKeyChange>') as List)
        .cast<TrackedChangesEdFiStaffSectionAssociationKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiStaffSectionAssociation] edFiStaffSectionAssociation (required):
  ///   The JSON representation of the \"staffSectionAssociation\" resource to be created or updated.
  Future<Response> postStaffSectionAssociationWithHttpInfo(EdFiStaffSectionAssociation edFiStaffSectionAssociation,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations';

    // ignore: prefer_final_locals
    Object? postBody = edFiStaffSectionAssociation;
  ...
  /// * [EdFiStaffSectionAssociation] edFiStaffSectionAssociation (required):
  ///   The JSON representation of the \"staffSectionAssociation\" resource to be created or updated.
  Future<void> postStaffSectionAssociation(EdFiStaffSectionAssociation edFiStaffSectionAssociation,) async {
    final response = await postStaffSectionAssociationWithHttpInfo(edFiStaffSectionAssociation,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putStaffSectionAssociationWithHttpInfo(String id, EdFiStaffSectionAssociation edFiStaffSectionAssociation, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/staffSectionAssociations/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putStaffSectionAssociation(String id, EdFiStaffSectionAssociation edFiStaffSectionAssociation, { String? ifMatch, }) async {
    final response = await putStaffSectionAssociationWithHttpInfo(id, edFiStaffSectionAssociation,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
