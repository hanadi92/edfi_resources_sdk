...
class EvaluationElementRatingsApi {
  EvaluationElementRatingsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteEvaluationElementRatingByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteEvaluationElementRatingById(String id, { String? ifMatch, }) async {
    final response = await deleteEvaluationElementRatingByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesEvaluationElementRatingsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings/deletes';
  ...
  Future<List<TrackedChangesTpdmEvaluationElementRatingDelete>?> deletesEvaluationElementRatings({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesEvaluationElementRatingsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmEvaluationElementRatingDelete>') as List)
        .cast<TrackedChangesTpdmEvaluationElementRatingDelete>()
  ...
  Future<Response> getEvaluationElementRatingsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, int? educationOrganizationId, String? evaluationElementTitle, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, DateTime? evaluationDate, String? personId, String? sourceSystemDescriptor, String? evaluationElementRatingLevelDescriptor, String? areaOfRefinement, String? areaOfReinforcement, String? comments, String? feedback, String? id, bool? useSnapshot, }) async {
    ...
    if (evaluationElementRatingLevelDescriptor != null) {
      queryParams.addAll(_queryParams('', 'evaluationElementRatingLevelDescriptor', evaluationElementRatingLevelDescriptor));
    }
    if (areaOfRefinement != null) {
      queryParams.addAll(_queryParams('', 'areaOfRefinement', areaOfRefinement));
    }
    if (areaOfReinforcement != null) {
      queryParams.addAll(_queryParams('', 'areaOfReinforcement', areaOfReinforcement));
    }
    if (comments != null) {
      queryParams.addAll(_queryParams('', 'comments', comments));
    }
    if (feedback != null) {
      queryParams.addAll(_queryParams('', 'feedback', feedback));
    }
    if (id != null) {
  ...
  Future<List<TpdmEvaluationElementRating>?> getEvaluationElementRatings({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, int? educationOrganizationId, String? evaluationElementTitle, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, DateTime? evaluationDate, String? personId, String? sourceSystemDescriptor, String? evaluationElementRatingLevelDescriptor, String? areaOfRefinement, String? areaOfReinforcement, String? comments, String? feedback, String? id, bool? useSnapshot, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TpdmEvaluationElementRating>') as List)
        .cast<TpdmEvaluationElementRating>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getEvaluationElementRatingsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings/{id}'
      .replaceAll('{id}', id);
  ...
  Future<TpdmEvaluationElementRating?> getEvaluationElementRatingsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getEvaluationElementRatingsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TpdmEvaluationElementRating',) as TpdmEvaluationElementRating;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getEvaluationElementRatingsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, int? educationOrganizationId, String? evaluationElementTitle, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, DateTime? evaluationDate, String? personId, String? sourceSystemDescriptor, String? evaluationElementRatingLevelDescriptor, String? areaOfRefinement, String? areaOfReinforcement, String? comments, String? feedback, String? id, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getEvaluationElementRatingsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, int? educationOrganizationId, String? evaluationElementTitle, String? evaluationObjectiveTitle, String? evaluationPeriodDescriptor, String? evaluationTitle, String? performanceEvaluationTitle, String? performanceEvaluationTypeDescriptor, int? schoolYear, String? termDescriptor, DateTime? evaluationDate, String? personId, String? sourceSystemDescriptor, String? evaluationElementRatingLevelDescriptor, String? areaOfRefinement, String? areaOfReinforcement, String? comments, String? feedback, String? id, bool? useSnapshot, }) async {
    final response = await getEvaluationElementRatingsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, educationOrganizationId: educationOrganizationId, evaluationElementTitle: evaluationElementTitle, evaluationObjectiveTitle: evaluationObjectiveTitle, evaluationPeriodDescriptor: evaluationPeriodDescriptor, evaluationTitle: evaluationTitle, performanceEvaluationTitle: performanceEvaluationTitle, performanceEvaluationTypeDescriptor: performanceEvaluationTypeDescriptor, schoolYear: schoolYear, termDescriptor: termDescriptor, evaluationDate: evaluationDate, personId: personId, sourceSystemDescriptor: sourceSystemDescriptor, evaluationElementRatingLevelDescriptor: evaluationElementRatingLevelDescriptor, areaOfRefinement: areaOfRefinement, areaOfReinforcement: areaOfReinforcement, comments: comments, feedback: feedback, id: id, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesEvaluationElementRatingsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings/keyChanges';
  ...
  Future<List<TrackedChangesTpdmEvaluationElementRatingKeyChange>?> keyChangesEvaluationElementRatings({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesEvaluationElementRatingsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesTpdmEvaluationElementRatingKeyChange>') as List)
        .cast<TrackedChangesTpdmEvaluationElementRatingKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [TpdmEvaluationElementRating] tpdmEvaluationElementRating (required):
  ///   The JSON representation of the \"evaluationElementRating\" resource to be created or updated.
  Future<Response> postEvaluationElementRatingWithHttpInfo(TpdmEvaluationElementRating tpdmEvaluationElementRating,) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings';

    // ignore: prefer_final_locals
    Object? postBody = tpdmEvaluationElementRating;
  ...
  /// * [TpdmEvaluationElementRating] tpdmEvaluationElementRating (required):
  ///   The JSON representation of the \"evaluationElementRating\" resource to be created or updated.
  Future<void> postEvaluationElementRating(TpdmEvaluationElementRating tpdmEvaluationElementRating,) async {
    final response = await postEvaluationElementRatingWithHttpInfo(tpdmEvaluationElementRating,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putEvaluationElementRatingWithHttpInfo(String id, TpdmEvaluationElementRating tpdmEvaluationElementRating, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/tpdm/evaluationElementRatings/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putEvaluationElementRating(String id, TpdmEvaluationElementRating tpdmEvaluationElementRating, { String? ifMatch, }) async {
    final response = await putEvaluationElementRatingWithHttpInfo(id, tpdmEvaluationElementRating,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
