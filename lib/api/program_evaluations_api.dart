...
class ProgramEvaluationsApi {
  ProgramEvaluationsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> deleteProgramEvaluationByIdWithHttpInfo(String id, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.
  Future<void> deleteProgramEvaluationById(String id, { String? ifMatch, }) async {
    final response = await deleteProgramEvaluationByIdWithHttpInfo(id,  ifMatch: ifMatch, );
  ...
  Future<Response> deletesProgramEvaluationsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations/deletes';
  ...
  Future<List<TrackedChangesEdFiProgramEvaluationDelete>?> deletesProgramEvaluations({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await deletesProgramEvaluationsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiProgramEvaluationDelete>') as List)
        .cast<TrackedChangesEdFiProgramEvaluationDelete>()
  ...
  Future<Response> getProgramEvaluationsWithHttpInfo({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? programEvaluationPeriodDescriptor, String? programEvaluationTypeDescriptor, String? programEvaluationTitle, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, double? evaluationMaxNumericRating, double? evaluationMinNumericRating, String? id, String? programEvaluationDescription, bool? useSnapshot, }) async {
    ...
    if (evaluationMaxNumericRating != null) {
      queryParams.addAll(_queryParams('', 'evaluationMaxNumericRating', evaluationMaxNumericRating));
    }
    if (evaluationMinNumericRating != null) {
      queryParams.addAll(_queryParams('', 'evaluationMinNumericRating', evaluationMinNumericRating));
    }
    if (id != null) {
      queryParams.addAll(_queryParams('', 'id', id));
    }
    if (programEvaluationDescription != null) {
      queryParams.addAll(_queryParams('', 'programEvaluationDescription', programEvaluationDescription));
    }
  ...
  Future<List<EdFiProgramEvaluation>?> getProgramEvaluations({ int? offset, int? limit, String? pageToken, int? pageSize, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, String? programEvaluationPeriodDescriptor, String? programEvaluationTypeDescriptor, String? programEvaluationTitle, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, double? evaluationMaxNumericRating, double? evaluationMinNumericRating, String? id, String? programEvaluationDescription, bool? useSnapshot, }) async {
    final response = await getProgramEvaluationsWithHttpInfo( offset: offset, limit: limit, pageToken: pageToken, pageSize: pageSize, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, programEvaluationPeriodDescriptor: programEvaluationPeriodDescriptor, programEvaluationTypeDescriptor: programEvaluationTypeDescriptor, programEvaluationTitle: programEvaluationTitle, programEducationOrganizationId: programEducationOrganizationId, programName: programName, programTypeDescriptor: programTypeDescriptor, evaluationMaxNumericRating: evaluationMaxNumericRating, evaluationMinNumericRating: evaluationMinNumericRating, id: id, programEvaluationDescription: programEvaluationDescription, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<EdFiProgramEvaluation>') as List)
        .cast<EdFiProgramEvaluation>()
        .toList(growable: false);
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramEvaluationsByIdWithHttpInfo(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations/{id}'
      .replaceAll('{id}', id);
  ...
  Future<EdFiProgramEvaluation?> getProgramEvaluationsById(String id, { String? ifNoneMatch, bool? useSnapshot, }) async {
    final response = await getProgramEvaluationsByIdWithHttpInfo(id,  ifNoneMatch: ifNoneMatch, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EdFiProgramEvaluation',) as EdFiProgramEvaluation;
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> getProgramEvaluationsPartitionsWithHttpInfo({ int? number, int? minChangeVersion, int? maxChangeVersion, String? programEvaluationPeriodDescriptor, String? programEvaluationTypeDescriptor, String? programEvaluationTitle, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, double? evaluationMaxNumericRating, double? evaluationMinNumericRating, String? id, String? programEvaluationDescription, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations/partitions';
  ...
  Future<GetAcademicWeeksPartitions200Response?> getProgramEvaluationsPartitions({ int? number, int? minChangeVersion, int? maxChangeVersion, String? programEvaluationPeriodDescriptor, String? programEvaluationTypeDescriptor, String? programEvaluationTitle, int? programEducationOrganizationId, String? programName, String? programTypeDescriptor, double? evaluationMaxNumericRating, double? evaluationMinNumericRating, String? id, String? programEvaluationDescription, bool? useSnapshot, }) async {
    final response = await getProgramEvaluationsPartitionsWithHttpInfo( number: number, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, programEvaluationPeriodDescriptor: programEvaluationPeriodDescriptor, programEvaluationTypeDescriptor: programEvaluationTypeDescriptor, programEvaluationTitle: programEvaluationTitle, programEducationOrganizationId: programEducationOrganizationId, programName: programName, programTypeDescriptor: programTypeDescriptor, evaluationMaxNumericRating: evaluationMaxNumericRating, evaluationMinNumericRating: evaluationMinNumericRating, id: id, programEvaluationDescription: programEvaluationDescription, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] useSnapshot:
  ///   Indicates if the configured Snapshot should be used.
  Future<Response> keyChangesProgramEvaluationsWithHttpInfo({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations/keyChanges';
  ...
  Future<List<TrackedChangesEdFiProgramEvaluationKeyChange>?> keyChangesProgramEvaluations({ int? offset, int? limit, int? minChangeVersion, int? maxChangeVersion, bool? totalCount, bool? useSnapshot, }) async {
    final response = await keyChangesProgramEvaluationsWithHttpInfo( offset: offset, limit: limit, minChangeVersion: minChangeVersion, maxChangeVersion: maxChangeVersion, totalCount: totalCount, useSnapshot: useSnapshot, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<TrackedChangesEdFiProgramEvaluationKeyChange>') as List)
        .cast<TrackedChangesEdFiProgramEvaluationKeyChange>()
        .toList(growable: false);
  ...
  /// Parameters:
  ///
  /// * [EdFiProgramEvaluation] edFiProgramEvaluation (required):
  ///   The JSON representation of the \"programEvaluation\" resource to be created or updated.
  Future<Response> postProgramEvaluationWithHttpInfo(EdFiProgramEvaluation edFiProgramEvaluation,) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations';

    // ignore: prefer_final_locals
    Object? postBody = edFiProgramEvaluation;
  ...
  /// * [EdFiProgramEvaluation] edFiProgramEvaluation (required):
  ///   The JSON representation of the \"programEvaluation\" resource to be created or updated.
  Future<void> postProgramEvaluation(EdFiProgramEvaluation edFiProgramEvaluation,) async {
    final response = await postProgramEvaluationWithHttpInfo(edFiProgramEvaluation,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> putProgramEvaluationWithHttpInfo(String id, EdFiProgramEvaluation edFiProgramEvaluation, { String? ifMatch, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ed-fi/programEvaluations/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] ifMatch:
  ///   The ETag header value used to prevent the PUT from updating a resource modified by another consumer.
  Future<void> putProgramEvaluation(String id, EdFiProgramEvaluation edFiProgramEvaluation, { String? ifMatch, }) async {
    final response = await putProgramEvaluationWithHttpInfo(id, edFiProgramEvaluation,  ifMatch: ifMatch, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
