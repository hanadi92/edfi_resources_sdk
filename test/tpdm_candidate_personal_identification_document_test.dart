...
// tests for TpdmCandidatePersonalIdentificationDocument
void main() {
  // final instance = TpdmCandidatePersonalIdentificationDocument();

  group('test TpdmCandidatePersonalIdentificationDocument', () {
    // The primary function of the document used for establishing identity.
    // String identificationDocumentUseDescriptor
    test('to test the property `identificationDocumentUseDescriptor`', () async {
      // TODO
    });

    // The category of the document relative to its purpose.
    // String personalInformationVerificationDescriptor
    test('to test the property `personalInformationVerificationDescriptor`', () async {
      // TODO
    });
