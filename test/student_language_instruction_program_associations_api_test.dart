...
/// tests for StudentLanguageInstructionProgramAssociationsApi
void main() {
  // final instance = StudentLanguageInstructionProgramAssociationsApi();

  group('tests for StudentLanguageInstructionProgramAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentLanguageInstructionProgramAssociationById(String id, { String ifMatch }) async
    test('test deleteStudentLanguageInstructionProgramAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentLanguageInstructionProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentLanguageInstructionProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentLanguageInstructionProgramAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStudentLanguageInstructionProgramAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentLanguageInstructionProgramAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentLanguageInstructionProgramAssociation(EdFiStudentLanguageInstructionProgramAssociation edFiStudentLanguageInstructionProgramAssociation) async
    test('test postStudentLanguageInstructionProgramAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentLanguageInstructionProgramAssociation(String id, EdFiStudentLanguageInstructionProgramAssociation edFiStudentLanguageInstructionProgramAssociation, { String ifMatch }) async
    test('test putStudentLanguageInstructionProgramAssociation', () async {
      // TODO
    });
