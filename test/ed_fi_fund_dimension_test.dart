...
// tests for EdFiFundDimension
void main() {
  // final instance = EdFiFundDimension();

  group('test EdFiFundDimension', () {
    // 
    // String id
    ...
    // List<EdFiFundDimensionReportingTag> reportingTags (default value: const [])
