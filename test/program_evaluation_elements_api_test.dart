...
/// tests for ProgramEvaluationElementsApi
void main() {
  // final instance = ProgramEvaluationElementsApi();

  group('tests for ProgramEvaluationElementsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteProgramEvaluationElementById(String id, { String ifMatch }) async
    test('test deleteProgramEvaluationElementById', () async {
      // TODO
    });
    ...
    test('test deletesProgramEvaluationElements', () async {
      // TODO
    });
    ...
    test('test getProgramEvaluationElements', () async {
      // TODO
    });
    ...
    test('test getProgramEvaluationElementsById', () async {
      // TODO
    });
    ...
    test('test getProgramEvaluationElementsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesProgramEvaluationElements', () async {
      // TODO
    });
    ...
    //
    //Future postProgramEvaluationElement(EdFiProgramEvaluationElement edFiProgramEvaluationElement) async
    test('test postProgramEvaluationElement', () async {
      // TODO
    });
    ...
    //
    //Future putProgramEvaluationElement(String id, EdFiProgramEvaluationElement edFiProgramEvaluationElement, { String ifMatch }) async
    test('test putProgramEvaluationElement', () async {
      // TODO
    });
