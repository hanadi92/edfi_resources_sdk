...
// tests for TrackedChangesEdFiGradeKey
void main() {
  // final instance = TrackedChangesEdFiGradeKey();

  group('test TrackedChangesEdFiGradeKey', () {
    // The type of grade reported (e.g., exam, final, grading period).
    // String gradeTypeDescriptor
    test('to test the property `gradeTypeDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `localCourseCode`', () async {
      // TODO
    });
    ...
    test('to test the property `sectionIdentifier`', () async {
      // TODO
    });

    // The identifier for the calendar for the academic session.
    // String sessionName
    test('to test the property `sessionName`', () async {
      // TODO
    });
