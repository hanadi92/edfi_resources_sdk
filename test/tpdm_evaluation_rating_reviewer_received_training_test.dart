...
// tests for TpdmEvaluationRatingReviewerReceivedTraining
void main() {
  // final instance = TpdmEvaluationRatingReviewerReceivedTraining();

  group('test TpdmEvaluationRatingReviewerReceivedTraining', () {
    ...
    test('to test the property `interRaterReliabilityScore`', () async {
      // TODO
    });
    ...
    test('to test the property `receivedTrainingDate`', () async {
      // TODO
    });
