...
// tests for EdFiStudentEducationOrganizationAssociationInternationalAddress
void main() {
  // final instance = EdFiStudentEducationOrganizationAssociationInternationalAddress();

  group('test EdFiStudentEducationOrganizationAssociationInternationalAddress', () {
    ...
    test('to test the property `countryDescriptor`', () async {
      // TODO
    });
    ...
    // String addressLine4
    test('to test the property `addressLine4`', () async {
      // TODO
    });
