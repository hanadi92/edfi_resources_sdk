...
/// tests for StaffCohortAssociationsApi
void main() {
  // final instance = StaffCohortAssociationsApi();

  group('tests for StaffCohortAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStaffCohortAssociationById(String id, { String ifMatch }) async
    test('test deleteStaffCohortAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStaffCohortAssociations', () async {
      // TODO
    });
    ...
    test('test getStaffCohortAssociations', () async {
      // TODO
    });
    ...
    test('test getStaffCohortAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStaffCohortAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStaffCohortAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStaffCohortAssociation(EdFiStaffCohortAssociation edFiStaffCohortAssociation) async
    test('test postStaffCohortAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStaffCohortAssociation(String id, EdFiStaffCohortAssociation edFiStaffCohortAssociation, { String ifMatch }) async
    test('test putStaffCohortAssociation', () async {
      // TODO
    });
