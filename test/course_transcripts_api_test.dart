...
/// tests for CourseTranscriptsApi
void main() {
  // final instance = CourseTranscriptsApi();

  group('tests for CourseTranscriptsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteCourseTranscriptById(String id, { String ifMatch }) async
    test('test deleteCourseTranscriptById', () async {
      // TODO
    });
    ...
    test('test deletesCourseTranscripts', () async {
      // TODO
    });
    ...
    test('test getCourseTranscripts', () async {
      // TODO
    });
    ...
    test('test getCourseTranscriptsById', () async {
      // TODO
    });
    ...
    test('test getCourseTranscriptsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesCourseTranscripts', () async {
      // TODO
    });
    ...
    //
    //Future postCourseTranscript(EdFiCourseTranscript edFiCourseTranscript) async
    test('test postCourseTranscript', () async {
      // TODO
    });
    ...
    //
    //Future putCourseTranscript(String id, EdFiCourseTranscript edFiCourseTranscript, { String ifMatch }) async
    test('test putCourseTranscript', () async {
      // TODO
    });
