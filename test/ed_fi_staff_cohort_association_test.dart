...
// tests for EdFiStaffCohortAssociation
void main() {
  // final instance = EdFiStaffCohortAssociation();

  group('test EdFiStaffCohortAssociation', () {
    // 
    // String id
    ...
    test('to test the property `cohortReference`', () async {
      // TODO
    });
    ...
    test('to test the property `studentRecordAccess`', () async {
      // TODO
    });
