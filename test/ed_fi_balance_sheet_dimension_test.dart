...
// tests for EdFiBalanceSheetDimension
void main() {
  // final instance = EdFiBalanceSheetDimension();

  group('test EdFiBalanceSheetDimension', () {
    // 
    // String id
    ...
    // List<EdFiBalanceSheetDimensionReportingTag> reportingTags (default value: const [])
