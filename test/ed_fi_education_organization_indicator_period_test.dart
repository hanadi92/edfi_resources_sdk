...
// tests for EdFiEducationOrganizationIndicatorPeriod
void main() {
  // final instance = EdFiEducationOrganizationIndicatorPeriod();

  group('test EdFiEducationOrganizationIndicatorPeriod', () {
