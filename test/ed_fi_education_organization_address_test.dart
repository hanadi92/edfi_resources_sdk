...
// tests for EdFiEducationOrganizationAddress
void main() {
  // final instance = EdFiEducationOrganizationAddress();

  group('test EdFiEducationOrganizationAddress', () {
    ...
    // List<EdFiEducationOrganizationAddressPeriod> periods (default value: const [])
