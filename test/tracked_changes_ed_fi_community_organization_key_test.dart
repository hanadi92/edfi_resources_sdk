...
// tests for TrackedChangesEdFiCommunityOrganizationKey
void main() {
  // final instance = TrackedChangesEdFiCommunityOrganizationKey();

  group('test TrackedChangesEdFiCommunityOrganizationKey', () {
    ...
    test('to test the property `communityOrganizationId`', () async {
      // TODO
    });
