...
// tests for EdFiStudentAcademicRecordRecognition
void main() {
  // final instance = EdFiStudentAcademicRecordRecognition();

  group('test EdFiStudentAcademicRecordRecognition', () {
    ...
    test('to test the property `recognitionTypeDescriptor`', () async {
      // TODO
    });

    // The category of achievement attributed to the individual.
    // String achievementCategoryDescriptor
    test('to test the property `achievementCategoryDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `achievementCategorySystem`', () async {
      // TODO
    });

    // The title assigned to the achievement.
    // String achievementTitle
    test('to test the property `achievementTitle`', () async {
      // TODO
    });
    ...
    // String criteriaURL
    test('to test the property `criteriaURL`', () async {
      // TODO
    });
    ...
    test('to test the property `evidenceStatement`', () async {
      // TODO
    });
    ...
    // String issuerName
    test('to test the property `issuerName`', () async {
      // TODO
    });

    // The Uniform Resource Locator (URL) from which the award was issued.
    // String issuerOriginURL
    test('to test the property `issuerOriginURL`', () async {
      // TODO
    });
    ...
    test('to test the property `recognitionAwardDate`', () async {
      // TODO
    });
    ...
    test('to test the property `recognitionAwardExpiresDate`', () async {
      // TODO
    });

    // A description of the type of recognition earned by or awarded to the individual.
    // String recognitionDescription
    test('to test the property `recognitionDescription`', () async {
      // TODO
    });
