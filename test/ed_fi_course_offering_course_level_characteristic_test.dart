...
// tests for EdFiCourseOfferingCourseLevelCharacteristic
void main() {
  // final instance = EdFiCourseOfferingCourseLevelCharacteristic();

  group('test EdFiCourseOfferingCourseLevelCharacteristic', () {
    ...
    test('to test the property `courseLevelCharacteristicDescriptor`', () async {
      // TODO
    });
