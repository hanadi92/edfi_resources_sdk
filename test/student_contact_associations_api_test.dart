...
/// tests for StudentContactAssociationsApi
void main() {
  // final instance = StudentContactAssociationsApi();

  group('tests for StudentContactAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentContactAssociationById(String id, { String ifMatch }) async
    test('test deleteStudentContactAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentContactAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentContactAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentContactAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStudentContactAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentContactAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentContactAssociation(EdFiStudentContactAssociation edFiStudentContactAssociation) async
    test('test postStudentContactAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentContactAssociation(String id, EdFiStudentContactAssociation edFiStudentContactAssociation, { String ifMatch }) async
    test('test putStudentContactAssociation', () async {
      // TODO
    });
