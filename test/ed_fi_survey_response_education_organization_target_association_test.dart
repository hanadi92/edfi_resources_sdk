...
// tests for EdFiSurveyResponseEducationOrganizationTargetAssociation
void main() {
  // final instance = EdFiSurveyResponseEducationOrganizationTargetAssociation();

  group('test EdFiSurveyResponseEducationOrganizationTargetAssociation', () {
    // 
    // String id
    ...
    test('to test the property `surveyResponseReference`', () async {
      // TODO
    });
