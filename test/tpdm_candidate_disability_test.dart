...
// tests for TpdmCandidateDisability
void main() {
  // final instance = TpdmCandidateDisability();

  group('test TpdmCandidateDisability', () {
    ...
    // List<TpdmCandidateDisabilityDesignation> designations (default value: const [])
