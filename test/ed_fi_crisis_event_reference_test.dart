...
// tests for EdFiCrisisEventReference
void main() {
  // final instance = EdFiCrisisEventReference();

  group('test EdFiCrisisEventReference', () {
    ...
    test('to test the property `crisisEventName`', () async {
      // TODO
    });
