...
// tests for TrackedChangesEdFiBellScheduleKey
void main() {
  // final instance = TrackedChangesEdFiBellScheduleKey();

  group('test TrackedChangesEdFiBellScheduleKey', () {
    // Name or title of the bell schedule.
    // String bellScheduleName
    test('to test the property `bellScheduleName`', () async {
      // TODO
    });
