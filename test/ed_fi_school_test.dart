...
// tests for EdFiSchool
void main() {
  // final instance = EdFiSchool();

  group('test EdFiSchool', () {
    // 
    // String id
    ...
    // List<EdFiEducationOrganizationCategory> educationOrganizationCategories (default value: const [])
    test('to test the property `educationOrganizationCategories`', () async {
      // TODO
    });

    // An unordered collection of schoolGradeLevels. The grade levels served at the school.
    // List<EdFiSchoolGradeLevel> gradeLevels (default value: const [])
    test('to test the property `gradeLevels`', () async {
      // TODO
    });
    ...
    test('to test the property `charterApprovalSchoolYearTypeReference`', () async {
      // TODO
    });

    // EdFiLocalEducationAgencyReference localEducationAgencyReference
    test('to test the property `localEducationAgencyReference`', () async {
      // TODO
    });
    ...
    // List<EdFiEducationOrganizationAddress> addresses (default value: const [])
    ...
    test('to test the property `administrativeFundingControlDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `charterApprovalAgencyTypeDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `charterStatusDescriptor`', () async {
      // TODO
    });
    ...
    // List<EdFiEducationOrganizationIdentificationCode> identificationCodes (default value: const [])
    test('to test the property `identificationCodes`', () async {
      // TODO
    });

    // An unordered collection of educationOrganizationIndicators. An indicator or metric of an education organization.
    // List<EdFiEducationOrganizationIndicator> indicators (default value: const [])
    test('to test the property `indicators`', () async {
      // TODO
    });
    ...
    // List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones (default value: const [])
    test('to test the property `institutionTelephones`', () async {
      // TODO
    });
    ...
    // List<EdFiEducationOrganizationInternationalAddress> internationalAddresses (default value: const [])
    test('to test the property `internationalAddresses`', () async {
      // TODO
    });

    // The type of Internet access available.
    // String internetAccessDescriptor
    test('to test the property `internetAccessDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `magnetSpecialProgramEmphasisSchoolDescriptor`', () async {
      // TODO
    });

    // The full, legally accepted name of the institution.
    // String nameOfInstitution
    test('to test the property `nameOfInstitution`', () async {
      // TODO
    });

    // The current operational status of the education organization (e.g., active, inactive).
    // String operationalStatusDescriptor
    test('to test the property `operationalStatusDescriptor`', () async {
      // TODO
    });

    // An unordered collection of schoolCategories. The one or more categories of school.
    // List<EdFiSchoolCategory> schoolCategories (default value: const [])
    test('to test the property `schoolCategories`', () async {
      // TODO
    });

    // The type of education institution as classified by its primary focus.
    // String schoolTypeDescriptor
    test('to test the property `schoolTypeDescriptor`', () async {
      // TODO
    });

    // A short name for the institution.
    // String shortNameOfInstitution
    test('to test the property `shortNameOfInstitution`', () async {
      // TODO
    });

    // Denotes the Title I Part A designation for the school.
    // String titleIPartASchoolDesignationDescriptor
    test('to test the property `titleIPartASchoolDesignationDescriptor`', () async {
      // TODO
    });
