...
// tests for EdFiInterventionStudyInterventionEffectiveness
void main() {
  // final instance = EdFiInterventionStudyInterventionEffectiveness();

  group('test EdFiInterventionStudyInterventionEffectiveness', () {
    ...
    test('to test the property `diagnosisDescriptor`', () async {
      // TODO
    });

    // Grade level for which effectiveness is measured.
    // String gradeLevelDescriptor
    test('to test the property `gradeLevelDescriptor`', () async {
      // TODO
    });

    // Population for which effectiveness is measured.
    // String populationServedDescriptor
    test('to test the property `populationServedDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `interventionEffectivenessRatingDescriptor`', () async {
      // TODO
    });
    ...
    test('to test the property `improvementIndex`', () async {
      // TODO
    });
