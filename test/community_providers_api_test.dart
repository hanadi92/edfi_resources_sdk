...
/// tests for CommunityProvidersApi
void main() {
  // final instance = CommunityProvidersApi();

  group('tests for CommunityProvidersApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteCommunityProviderById(String id, { String ifMatch }) async
    test('test deleteCommunityProviderById', () async {
      // TODO
    });
    ...
    test('test deletesCommunityProviders', () async {
      // TODO
    });
    ...
    test('test getCommunityProviders', () async {
      // TODO
    });
    ...
    test('test getCommunityProvidersById', () async {
      // TODO
    });
    ...
    test('test getCommunityProvidersPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesCommunityProviders', () async {
      // TODO
    });
    ...
    //
    //Future postCommunityProvider(EdFiCommunityProvider edFiCommunityProvider) async
    test('test postCommunityProvider', () async {
      // TODO
    });
    ...
    //
    //Future putCommunityProvider(String id, EdFiCommunityProvider edFiCommunityProvider, { String ifMatch }) async
    test('test putCommunityProvider', () async {
      // TODO
    });
