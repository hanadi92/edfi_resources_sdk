...
/// tests for OpenStaffPositionsApi
void main() {
  // final instance = OpenStaffPositionsApi();

  group('tests for OpenStaffPositionsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteOpenStaffPositionById(String id, { String ifMatch }) async
    test('test deleteOpenStaffPositionById', () async {
      // TODO
    });
    ...
    test('test deletesOpenStaffPositions', () async {
      // TODO
    });
    ...
    test('test getOpenStaffPositions', () async {
      // TODO
    });
    ...
    test('test getOpenStaffPositionsById', () async {
      // TODO
    });
    ...
    test('test getOpenStaffPositionsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesOpenStaffPositions', () async {
      // TODO
    });
    ...
    //
    //Future postOpenStaffPosition(EdFiOpenStaffPosition edFiOpenStaffPosition) async
    test('test postOpenStaffPosition', () async {
      // TODO
    });
    ...
    //
    //Future putOpenStaffPosition(String id, EdFiOpenStaffPosition edFiOpenStaffPosition, { String ifMatch }) async
    test('test putOpenStaffPosition', () async {
      // TODO
    });
