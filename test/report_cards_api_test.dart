...
void main() {
  // final instance = ReportCardsApi();

  group('tests for ReportCardsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteReportCardById(String id, { String ifMatch }) async
    test('test deleteReportCardById', () async {
      // TODO
    });
    ...
    test('test deletesReportCards', () async {
      // TODO
    });
    ...
    test('test getReportCards', () async {
      // TODO
    });
    ...
    test('test getReportCardsById', () async {
      // TODO
    });
    ...
    test('test getReportCardsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesReportCards', () async {
      // TODO
    });
    ...
    //
    //Future postReportCard(EdFiReportCard edFiReportCard) async
    test('test postReportCard', () async {
      // TODO
    });
    ...
    //
    //Future putReportCard(String id, EdFiReportCard edFiReportCard, { String ifMatch }) async
    test('test putReportCard', () async {
      // TODO
    });
