...
/// tests for StudentSection504ProgramAssociationsApi
void main() {
  // final instance = StudentSection504ProgramAssociationsApi();

  group('tests for StudentSection504ProgramAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentSection504ProgramAssociationById(String id, { String ifMatch }) async
    test('test deleteStudentSection504ProgramAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentSection504ProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentSection504ProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentSection504ProgramAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStudentSection504ProgramAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentSection504ProgramAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentSection504ProgramAssociation(EdFiStudentSection504ProgramAssociation edFiStudentSection504ProgramAssociation) async
    test('test postStudentSection504ProgramAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentSection504ProgramAssociation(String id, EdFiStudentSection504ProgramAssociation edFiStudentSection504ProgramAssociation, { String ifMatch }) async
    test('test putStudentSection504ProgramAssociation', () async {
      // TODO
    });
