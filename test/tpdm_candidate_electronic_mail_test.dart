...
// tests for TpdmCandidateElectronicMail
void main() {
  // final instance = TpdmCandidateElectronicMail();

  group('test TpdmCandidateElectronicMail', () {
    ...
    test('to test the property `electronicMailTypeDescriptor`', () async {
      // TODO
    });

    // The electronic mail (e-mail) address listed for an individual or organization.
    // String electronicMailAddress
    test('to test the property `electronicMailAddress`', () async {
      // TODO
    });
    ...
    test('to test the property `primaryEmailAddressIndicator`', () async {
      // TODO
    });
