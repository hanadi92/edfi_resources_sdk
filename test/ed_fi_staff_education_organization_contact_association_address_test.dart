...
// tests for EdFiStaffEducationOrganizationContactAssociationAddress
void main() {
  // final instance = EdFiStaffEducationOrganizationContactAssociationAddress();

  group('test EdFiStaffEducationOrganizationContactAssociationAddress', () {
    ...
    test('to test the property `stateAbbreviationDescriptor`', () async {
      // TODO
    });

    // The apartment, room, or suite number of an address.
    // String apartmentRoomSuiteNumber
    test('to test the property `apartmentRoomSuiteNumber`', () async {
      // TODO
    });

    // The number of the building on the site, if more than one building shares the same address.
    // String buildingSiteNumber
    test('to test the property `buildingSiteNumber`', () async {
      // TODO
    });
    ...
    // String nameOfCounty
    test('to test the property `nameOfCounty`', () async {
      // TODO
    });
    ...
    test('to test the property `streetNumberName`', () async {
      // TODO
    });
    ...
    // List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod> periods (default value: const [])
