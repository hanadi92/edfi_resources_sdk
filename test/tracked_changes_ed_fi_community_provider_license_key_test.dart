...
// tests for TrackedChangesEdFiCommunityProviderLicenseKey
void main() {
  // final instance = TrackedChangesEdFiCommunityProviderLicenseKey();

  group('test TrackedChangesEdFiCommunityProviderLicenseKey', () {
    // The unique identifier issued by the licensing organization.
    // String licenseIdentifier
    test('to test the property `licenseIdentifier`', () async {
      // TODO
    });

    // The organization issuing the license.
    // String licensingOrganization
    test('to test the property `licensingOrganization`', () async {
      // TODO
    });
