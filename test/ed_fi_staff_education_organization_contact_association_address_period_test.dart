...
// tests for EdFiStaffEducationOrganizationContactAssociationAddressPeriod
void main() {
  // final instance = EdFiStaffEducationOrganizationContactAssociationAddressPeriod();

  group('test EdFiStaffEducationOrganizationContactAssociationAddressPeriod', () {
