...
/// tests for StudentSpecialEducationProgramEligibilityAssociationsApi
void main() {
  // final instance = StudentSpecialEducationProgramEligibilityAssociationsApi();

  group('tests for StudentSpecialEducationProgramEligibilityAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentSpecialEducationProgramEligibilityAssociationById(String id, { String ifMatch }) async
    test('test deleteStudentSpecialEducationProgramEligibilityAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentSpecialEducationProgramEligibilityAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentSpecialEducationProgramEligibilityAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentSpecialEducationProgramEligibilityAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStudentSpecialEducationProgramEligibilityAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentSpecialEducationProgramEligibilityAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentSpecialEducationProgramEligibilityAssociation(EdFiStudentSpecialEducationProgramEligibilityAssociation edFiStudentSpecialEducationProgramEligibilityAssociation) async
    test('test postStudentSpecialEducationProgramEligibilityAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentSpecialEducationProgramEligibilityAssociation(String id, EdFiStudentSpecialEducationProgramEligibilityAssociation edFiStudentSpecialEducationProgramEligibilityAssociation, { String ifMatch }) async
    test('test putStudentSpecialEducationProgramEligibilityAssociation', () async {
      // TODO
    });
