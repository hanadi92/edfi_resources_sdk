...
// tests for TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey
void main() {
  // final instance = TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey();

  group('test TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey', () {
    // Describes behavior by category.
    // String behaviorDescriptor
    test('to test the property `behaviorDescriptor`', () async {
      // TODO
    });
