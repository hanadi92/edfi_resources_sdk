...
/// tests for LocalEducationAgenciesApi
void main() {
  // final instance = LocalEducationAgenciesApi();

  group('tests for LocalEducationAgenciesApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteLocalEducationAgencyById(String id, { String ifMatch }) async
    test('test deleteLocalEducationAgencyById', () async {
      // TODO
    });
    ...
    test('test deletesLocalEducationAgencies', () async {
      // TODO
    });
    ...
    test('test getLocalEducationAgencies', () async {
      // TODO
    });
    ...
    test('test getLocalEducationAgenciesById', () async {
      // TODO
    });
    ...
    test('test getLocalEducationAgenciesPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesLocalEducationAgencies', () async {
      // TODO
    });
    ...
    //
    //Future postLocalEducationAgency(EdFiLocalEducationAgency edFiLocalEducationAgency) async
    test('test postLocalEducationAgency', () async {
      // TODO
    });
    ...
    //
    //Future putLocalEducationAgency(String id, EdFiLocalEducationAgency edFiLocalEducationAgency, { String ifMatch }) async
    test('test putLocalEducationAgency', () async {
      // TODO
    });
