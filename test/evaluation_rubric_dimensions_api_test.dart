...
/// tests for EvaluationRubricDimensionsApi
void main() {
  // final instance = EvaluationRubricDimensionsApi();

  group('tests for EvaluationRubricDimensionsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteEvaluationRubricDimensionById(String id, { String ifMatch }) async
    test('test deleteEvaluationRubricDimensionById', () async {
      // TODO
    });
    ...
    test('test deletesEvaluationRubricDimensions', () async {
      // TODO
    });
    ...
    test('test getEvaluationRubricDimensions', () async {
      // TODO
    });
    ...
    test('test getEvaluationRubricDimensionsById', () async {
      // TODO
    });
    ...
    test('test getEvaluationRubricDimensionsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesEvaluationRubricDimensions', () async {
      // TODO
    });
    ...
    //
    //Future postEvaluationRubricDimension(EdFiEvaluationRubricDimension edFiEvaluationRubricDimension) async
    test('test postEvaluationRubricDimension', () async {
      // TODO
    });
    ...
    //
    //Future putEvaluationRubricDimension(String id, EdFiEvaluationRubricDimension edFiEvaluationRubricDimension, { String ifMatch }) async
    test('test putEvaluationRubricDimension', () async {
      // TODO
    });
