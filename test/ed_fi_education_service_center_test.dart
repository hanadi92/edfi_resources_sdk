...
// tests for EdFiEducationServiceCenter
void main() {
  // final instance = EdFiEducationServiceCenter();

  group('test EdFiEducationServiceCenter', () {
    // 
    // String id
    ...
    test('to test the property `educationServiceCenterId`', () async {
      // TODO
    });

    // EdFiStateEducationAgencyReference stateEducationAgencyReference
    test('to test the property `stateEducationAgencyReference`', () async {
      // TODO
    });
