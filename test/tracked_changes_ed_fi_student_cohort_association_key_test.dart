...
// tests for TrackedChangesEdFiStudentCohortAssociationKey
void main() {
  // final instance = TrackedChangesEdFiStudentCohortAssociationKey();

  group('test TrackedChangesEdFiStudentCohortAssociationKey', () {
    ...
    test('to test the property `cohortIdentifier`', () async {
      // TODO
    });
