...
// tests for TpdmCandidateLanguage
void main() {
  // final instance = TpdmCandidateLanguage();

  group('test TpdmCandidateLanguage', () {
    // A specification of which written or spoken communication is being used.
    // String languageDescriptor
    test('to test the property `languageDescriptor`', () async {
      // TODO
    });
    ...
    // List<TpdmCandidateLanguageUse> uses (default value: const [])
