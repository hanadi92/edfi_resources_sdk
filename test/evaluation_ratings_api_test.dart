...
/// tests for EvaluationRatingsApi
void main() {
  // final instance = EvaluationRatingsApi();

  group('tests for EvaluationRatingsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteEvaluationRatingById(String id, { String ifMatch }) async
    test('test deleteEvaluationRatingById', () async {
      // TODO
    });
    ...
    test('test deletesEvaluationRatings', () async {
      // TODO
    });
    ...
    test('test getEvaluationRatings', () async {
      // TODO
    });
    ...
    test('test getEvaluationRatingsById', () async {
      // TODO
    });
    ...
    test('test getEvaluationRatingsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesEvaluationRatings', () async {
      // TODO
    });
    ...
    //
    //Future postEvaluationRating(TpdmEvaluationRating tpdmEvaluationRating) async
    test('test postEvaluationRating', () async {
      // TODO
    });
    ...
    //
    //Future putEvaluationRating(String id, TpdmEvaluationRating tpdmEvaluationRating, { String ifMatch }) async
    test('test putEvaluationRating', () async {
      // TODO
    });
