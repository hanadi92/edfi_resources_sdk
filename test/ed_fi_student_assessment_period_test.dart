...
// tests for EdFiStudentAssessmentPeriod
void main() {
  // final instance = EdFiStudentAssessmentPeriod();

  group('test EdFiStudentAssessmentPeriod', () {
    ...
    test('to test the property `assessmentPeriodDescriptor`', () async {
      // TODO
    });
