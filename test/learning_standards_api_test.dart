...
/// tests for LearningStandardsApi
void main() {
  // final instance = LearningStandardsApi();

  group('tests for LearningStandardsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteLearningStandardById(String id, { String ifMatch }) async
    test('test deleteLearningStandardById', () async {
      // TODO
    });
    ...
    test('test deletesLearningStandards', () async {
      // TODO
    });
    ...
    test('test getLearningStandards', () async {
      // TODO
    });
    ...
    test('test getLearningStandardsById', () async {
      // TODO
    });
    ...
    test('test getLearningStandardsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesLearningStandards', () async {
      // TODO
    });
    ...
    //
    //Future postLearningStandard(EdFiLearningStandard edFiLearningStandard) async
    test('test postLearningStandard', () async {
      // TODO
    });
    ...
    //
    //Future putLearningStandard(String id, EdFiLearningStandard edFiLearningStandard, { String ifMatch }) async
    test('test putLearningStandard', () async {
      // TODO
    });
