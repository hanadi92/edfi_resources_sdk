...
// tests for EdFiEducationOrganizationNetworkReference
void main() {
  // final instance = EdFiEducationOrganizationNetworkReference();

  group('test EdFiEducationOrganizationNetworkReference', () {
