...
// tests for EdFiObjectDimension
void main() {
  // final instance = EdFiObjectDimension();

  group('test EdFiObjectDimension', () {
    // 
    // String id
    ...
    // List<EdFiObjectDimensionReportingTag> reportingTags (default value: const [])
