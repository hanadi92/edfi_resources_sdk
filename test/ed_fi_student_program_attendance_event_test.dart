...
// tests for EdFiStudentProgramAttendanceEvent
void main() {
  // final instance = EdFiStudentProgramAttendanceEvent();

  group('test EdFiStudentProgramAttendanceEvent', () {
    // 
    // String id
    ...
    test('to test the property `programAttendanceDuration`', () async {
      // TODO
    });
