...
/// tests for AssessmentScoreRangeLearningStandardsApi
void main() {
  // final instance = AssessmentScoreRangeLearningStandardsApi();

  group('tests for AssessmentScoreRangeLearningStandardsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteAssessmentScoreRangeLearningStandardById(String id, { String ifMatch }) async
    test('test deleteAssessmentScoreRangeLearningStandardById', () async {
      // TODO
    });
    ...
    test('test deletesAssessmentScoreRangeLearningStandards', () async {
      // TODO
    });
    ...
    test('test getAssessmentScoreRangeLearningStandards', () async {
      // TODO
    });
    ...
    test('test getAssessmentScoreRangeLearningStandardsById', () async {
      // TODO
    });
    ...
    test('test getAssessmentScoreRangeLearningStandardsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesAssessmentScoreRangeLearningStandards', () async {
      // TODO
    });
    ...
    //
    //Future postAssessmentScoreRangeLearningStandard(EdFiAssessmentScoreRangeLearningStandard edFiAssessmentScoreRangeLearningStandard) async
    test('test postAssessmentScoreRangeLearningStandard', () async {
      // TODO
    });
    ...
    //
    //Future putAssessmentScoreRangeLearningStandard(String id, EdFiAssessmentScoreRangeLearningStandard edFiAssessmentScoreRangeLearningStandard, { String ifMatch }) async
    test('test putAssessmentScoreRangeLearningStandard', () async {
      // TODO
    });
