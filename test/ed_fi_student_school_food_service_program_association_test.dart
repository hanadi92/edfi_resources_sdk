...
// tests for EdFiStudentSchoolFoodServiceProgramAssociation
void main() {
  // final instance = EdFiStudentSchoolFoodServiceProgramAssociation();

  group('test EdFiStudentSchoolFoodServiceProgramAssociation', () {
    // 
    // String id
    ...
    test('to test the property `directCertification`', () async {
      // TODO
    });
    ...
    // List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService> schoolFoodServiceProgramServices (default value: const [])
    test('to test the property `schoolFoodServiceProgramServices`', () async {
      // TODO
    });
