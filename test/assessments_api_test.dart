...
void main() {
  // final instance = AssessmentsApi();

  group('tests for AssessmentsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteAssessmentById(String id, { String ifMatch }) async
    test('test deleteAssessmentById', () async {
      // TODO
    });
    ...
    test('test deletesAssessments', () async {
      // TODO
    });
    ...
    test('test getAssessments', () async {
      // TODO
    });
    ...
    test('test getAssessmentsById', () async {
      // TODO
    });
    ...
    test('test getAssessmentsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesAssessments', () async {
      // TODO
    });
    ...
    //
    //Future postAssessment(EdFiAssessment edFiAssessment) async
    test('test postAssessment', () async {
      // TODO
    });
    ...
    //
    //Future putAssessment(String id, EdFiAssessment edFiAssessment, { String ifMatch }) async
    test('test putAssessment', () async {
      // TODO
    });
