...
// tests for EdFiStudentEducationOrganizationAssociationStudentIndicatorPeriod
void main() {
  // final instance = EdFiStudentEducationOrganizationAssociationStudentIndicatorPeriod();

  group('test EdFiStudentEducationOrganizationAssociationStudentIndicatorPeriod', () {
