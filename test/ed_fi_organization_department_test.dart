...
// tests for EdFiOrganizationDepartment
void main() {
  // final instance = EdFiOrganizationDepartment();

  group('test EdFiOrganizationDepartment', () {
    // 
    // String id
    ...
    test('to test the property `organizationDepartmentId`', () async {
      // TODO
    });

    // EdFiEducationOrganizationReference parentEducationOrganizationReference
    test('to test the property `parentEducationOrganizationReference`', () async {
      // TODO
    });
