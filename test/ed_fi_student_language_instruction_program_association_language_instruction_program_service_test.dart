...
// tests for EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService
void main() {
  // final instance = EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService();

  group('test EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService', () {
    ...
    test('to test the property `languageInstructionProgramServiceDescriptor`', () async {
      // TODO
    });
