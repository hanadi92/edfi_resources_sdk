...
/// tests for StaffsApi
void main() {
  // final instance = StaffsApi();

  group('tests for StaffsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStaffById(String id, { String ifMatch }) async
    test('test deleteStaffById', () async {
      // TODO
    });
    ...
    test('test getStaffsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStaffs', () async {
      // TODO
    });
    ...
    //
    //Future postStaff(EdFiStaff edFiStaff) async
    test('test postStaff', () async {
      // TODO
    });
    ...
    //
    //Future putStaff(String id, EdFiStaff edFiStaff, { String ifMatch }) async
    test('test putStaff', () async {
      // TODO
    });
