...
// tests for EdFiAssessmentContentStandard
void main() {
  // final instance = EdFiAssessmentContentStandard();

  group('test EdFiAssessmentContentStandard', () {
    // The publication status of the document (i.e., Adopted, Draft, Published, Deprecated, Unknown).
    // String publicationStatusDescriptor
    test('to test the property `publicationStatusDescriptor`', () async {
      // TODO
    });
    ...
    // int publicationYear
    test('to test the property `publicationYear`', () async {
      // TODO
    });
    ...
    test('to test the property `mandatingEducationOrganizationReference`', () async {
      // TODO
    });
    ...
    // List<EdFiAssessmentContentStandardAuthor> authors (default value: const [])
