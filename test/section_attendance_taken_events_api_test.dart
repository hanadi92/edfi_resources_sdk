...
/// tests for SectionAttendanceTakenEventsApi
void main() {
  // final instance = SectionAttendanceTakenEventsApi();

  group('tests for SectionAttendanceTakenEventsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteSectionAttendanceTakenEventById(String id, { String ifMatch }) async
    test('test deleteSectionAttendanceTakenEventById', () async {
      // TODO
    });
    ...
    test('test deletesSectionAttendanceTakenEvents', () async {
      // TODO
    });
    ...
    test('test getSectionAttendanceTakenEvents', () async {
      // TODO
    });
    ...
    test('test getSectionAttendanceTakenEventsById', () async {
      // TODO
    });
    ...
    test('test getSectionAttendanceTakenEventsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesSectionAttendanceTakenEvents', () async {
      // TODO
    });
    ...
    //
    //Future postSectionAttendanceTakenEvent(EdFiSectionAttendanceTakenEvent edFiSectionAttendanceTakenEvent) async
    test('test postSectionAttendanceTakenEvent', () async {
      // TODO
    });
    ...
    //
    //Future putSectionAttendanceTakenEvent(String id, EdFiSectionAttendanceTakenEvent edFiSectionAttendanceTakenEvent, { String ifMatch }) async
    test('test putSectionAttendanceTakenEvent', () async {
      // TODO
    });
