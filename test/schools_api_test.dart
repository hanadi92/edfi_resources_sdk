...
void main() {
  // final instance = SchoolsApi();

  group('tests for SchoolsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteSchoolById(String id, { String ifMatch }) async
    test('test deleteSchoolById', () async {
      // TODO
    });
    ...
    test('test deletesSchools', () async {
      // TODO
    });
    ...
    test('test getSchoolsById', () async {
      // TODO
    });
    ...
    test('test getSchoolsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesSchools', () async {
      // TODO
    });
    ...
    //
    //Future postSchool(EdFiSchool edFiSchool) async
    test('test postSchool', () async {
      // TODO
    });
    ...
    //
    //Future putSchool(String id, EdFiSchool edFiSchool, { String ifMatch }) async
    test('test putSchool', () async {
      // TODO
    });
