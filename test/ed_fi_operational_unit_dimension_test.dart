...
// tests for EdFiOperationalUnitDimension
void main() {
  // final instance = EdFiOperationalUnitDimension();

  group('test EdFiOperationalUnitDimension', () {
    // 
    // String id
    ...
    // String codeName
    test('to test the property `codeName`', () async {
      // TODO
    });

    // An unordered collection of operationalUnitDimensionReportingTags. Optional tag for accountability reporting.
    // List<EdFiOperationalUnitDimensionReportingTag> reportingTags (default value: const [])
    test('to test the property `reportingTags`', () async {
      // TODO
    });
