...
// tests for EdFiStateEducationAgency
void main() {
  // final instance = EdFiStateEducationAgency();

  group('test EdFiStateEducationAgency', () {
    // 
    // String id
    ...
    test('to test the property `stateEducationAgencyId`', () async {
      // TODO
    });
    ...
    // List<EdFiStateEducationAgencyAccountability> accountabilities (default value: const [])
    test('to test the property `accountabilities`', () async {
      // TODO
    });
    ...
    // List<EdFiStateEducationAgencyFederalFunds> federalFunds (default value: const [])
    test('to test the property `federalFunds`', () async {
      // TODO
    });
