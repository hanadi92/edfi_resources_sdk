...
// tests for EdFiStudentInterventionAttendanceEvent
void main() {
  // final instance = EdFiStudentInterventionAttendanceEvent();

  group('test EdFiStudentInterventionAttendanceEvent', () {
    // 
    // String id
    ...
    test('to test the property `interventionReference`', () async {
      // TODO
    });
    ...
    test('to test the property `interventionDuration`', () async {
      // TODO
    });
