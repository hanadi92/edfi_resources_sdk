...
/// tests for RubricDimensionsApi
void main() {
  // final instance = RubricDimensionsApi();

  group('tests for RubricDimensionsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteRubricDimensionById(String id, { String ifMatch }) async
    test('test deleteRubricDimensionById', () async {
      // TODO
    });
    ...
    test('test deletesRubricDimensions', () async {
      // TODO
    });
    ...
    test('test getRubricDimensions', () async {
      // TODO
    });
    ...
    test('test getRubricDimensionsById', () async {
      // TODO
    });
    ...
    test('test getRubricDimensionsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesRubricDimensions', () async {
      // TODO
    });
    ...
    //
    //Future postRubricDimension(TpdmRubricDimension tpdmRubricDimension) async
    test('test postRubricDimension', () async {
      // TODO
    });
    ...
    //
    //Future putRubricDimension(String id, TpdmRubricDimension tpdmRubricDimension, { String ifMatch }) async
    test('test putRubricDimension', () async {
      // TODO
    });
