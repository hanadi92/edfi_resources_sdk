...
// tests for TrackedChangesEdFiClassPeriodKey
void main() {
  // final instance = TrackedChangesEdFiClassPeriodKey();

  group('test TrackedChangesEdFiClassPeriodKey', () {
    ...
    test('to test the property `classPeriodName`', () async {
      // TODO
    });
