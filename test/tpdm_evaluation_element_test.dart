...
// tests for TpdmEvaluationElement
void main() {
  // final instance = TpdmEvaluationElement();

  group('test TpdmEvaluationElement', () {
    // 
    // String id
    ...
    // List<TpdmEvaluationElementRatingLevel> ratingLevels (default value: const [])
    test('to test the property `ratingLevels`', () async {
      // TODO
    });
