...
// tests for TrackedChangesEdFiCalendarDateKey
void main() {
  // final instance = TrackedChangesEdFiCalendarDateKey();

  group('test TrackedChangesEdFiCalendarDateKey', () {
    ...
    // String calendarCode
    test('to test the property `calendarCode`', () async {
      // TODO
    });
