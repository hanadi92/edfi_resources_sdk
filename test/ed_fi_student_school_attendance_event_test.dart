...
// tests for EdFiStudentSchoolAttendanceEvent
void main() {
  // final instance = EdFiStudentSchoolAttendanceEvent();

  group('test EdFiStudentSchoolAttendanceEvent', () {
    // 
    // String id
    ...
    test('to test the property `sessionReference`', () async {
      // TODO
    });
    ...
    test('to test the property `schoolAttendanceDuration`', () async {
      // TODO
    });
