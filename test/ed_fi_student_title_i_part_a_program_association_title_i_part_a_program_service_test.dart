...
// tests for EdFiStudentTitleIPartAProgramAssociationTitleIPartAProgramService
void main() {
  // final instance = EdFiStudentTitleIPartAProgramAssociationTitleIPartAProgramService();

  group('test EdFiStudentTitleIPartAProgramAssociationTitleIPartAProgramService', () {
    ...
    test('to test the property `titleIPartAProgramServiceDescriptor`', () async {
      // TODO
    });
