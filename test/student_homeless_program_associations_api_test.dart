...
/// tests for StudentHomelessProgramAssociationsApi
void main() {
  // final instance = StudentHomelessProgramAssociationsApi();

  group('tests for StudentHomelessProgramAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentHomelessProgramAssociationById(String id, { String ifMatch }) async
    test('test deleteStudentHomelessProgramAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentHomelessProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentHomelessProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentHomelessProgramAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStudentHomelessProgramAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentHomelessProgramAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentHomelessProgramAssociation(EdFiStudentHomelessProgramAssociation edFiStudentHomelessProgramAssociation) async
    test('test postStudentHomelessProgramAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentHomelessProgramAssociation(String id, EdFiStudentHomelessProgramAssociation edFiStudentHomelessProgramAssociation, { String ifMatch }) async
    test('test putStudentHomelessProgramAssociation', () async {
      // TODO
    });
