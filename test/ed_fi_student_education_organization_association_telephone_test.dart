...
// tests for EdFiStudentEducationOrganizationAssociationTelephone
void main() {
  // final instance = EdFiStudentEducationOrganizationAssociationTelephone();

  group('test EdFiStudentEducationOrganizationAssociationTelephone', () {
