...
/// tests for CrisisEventsApi
void main() {
  // final instance = CrisisEventsApi();

  group('tests for CrisisEventsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteCrisisEventById(String id, { String ifMatch }) async
    test('test deleteCrisisEventById', () async {
      // TODO
    });
    ...
    test('test deletesCrisisEvents', () async {
      // TODO
    });
    ...
    test('test getCrisisEvents', () async {
      // TODO
    });
    ...
    test('test getCrisisEventsById', () async {
      // TODO
    });
    ...
    test('test getCrisisEventsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesCrisisEvents', () async {
      // TODO
    });
    ...
    //
    //Future postCrisisEvent(EdFiCrisisEvent edFiCrisisEvent) async
    test('test postCrisisEvent', () async {
      // TODO
    });
    ...
    //
    //Future putCrisisEvent(String id, EdFiCrisisEvent edFiCrisisEvent, { String ifMatch }) async
    test('test putCrisisEvent', () async {
      // TODO
    });
