...
// tests for EdFiStudentSectionAssociationReference
void main() {
  // final instance = EdFiStudentSectionAssociationReference();

  group('test EdFiStudentSectionAssociationReference', () {
