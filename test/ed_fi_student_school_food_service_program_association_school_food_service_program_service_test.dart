...
// tests for EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService
void main() {
  // final instance = EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService();

  group('test EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService', () {
    ...
    test('to test the property `schoolFoodServiceProgramServiceDescriptor`', () async {
      // TODO
    });

    // True if service is a primary service.
    // bool primaryIndicator
    test('to test the property `primaryIndicator`', () async {
      // TODO
    });
    ...
    test('to test the property `serviceBeginDate`', () async {
      // TODO
    });
