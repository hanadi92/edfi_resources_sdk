...
// tests for EdFiSurveySectionAssociation
void main() {
  // final instance = EdFiSurveySectionAssociation();

  group('test EdFiSurveySectionAssociation', () {
    // 
    // String id
    ...
    test('to test the property `surveyReference`', () async {
      // TODO
    });
