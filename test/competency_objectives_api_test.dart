...
/// tests for CompetencyObjectivesApi
void main() {
  // final instance = CompetencyObjectivesApi();

  group('tests for CompetencyObjectivesApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteCompetencyObjectiveById(String id, { String ifMatch }) async
    test('test deleteCompetencyObjectiveById', () async {
      // TODO
    });
    ...
    test('test deletesCompetencyObjectives', () async {
      // TODO
    });
    ...
    test('test getCompetencyObjectives', () async {
      // TODO
    });
    ...
    test('test getCompetencyObjectivesById', () async {
      // TODO
    });
    ...
    test('test getCompetencyObjectivesPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesCompetencyObjectives', () async {
      // TODO
    });
    ...
    //
    //Future postCompetencyObjective(EdFiCompetencyObjective edFiCompetencyObjective) async
    test('test postCompetencyObjective', () async {
      // TODO
    });
    ...
    //
    //Future putCompetencyObjective(String id, EdFiCompetencyObjective edFiCompetencyObjective, { String ifMatch }) async
    test('test putCompetencyObjective', () async {
      // TODO
    });
