...
/// tests for LocalContractedStaffsApi
void main() {
  // final instance = LocalContractedStaffsApi();

  group('tests for LocalContractedStaffsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteLocalContractedStaffById(String id, { String ifMatch }) async
    test('test deleteLocalContractedStaffById', () async {
      // TODO
    });
    ...
    test('test deletesLocalContractedStaffs', () async {
      // TODO
    });
    ...
    test('test getLocalContractedStaffs', () async {
      // TODO
    });
    ...
    test('test getLocalContractedStaffsById', () async {
      // TODO
    });
    ...
    test('test getLocalContractedStaffsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesLocalContractedStaffs', () async {
      // TODO
    });
    ...
    //
    //Future postLocalContractedStaff(EdFiLocalContractedStaff edFiLocalContractedStaff) async
    test('test postLocalContractedStaff', () async {
      // TODO
    });
    ...
    //
    //Future putLocalContractedStaff(String id, EdFiLocalContractedStaff edFiLocalContractedStaff, { String ifMatch }) async
    test('test putLocalContractedStaff', () async {
      // TODO
    });
