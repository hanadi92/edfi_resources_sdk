...
// tests for EdFiStudentProgramAssociationService
void main() {
  // final instance = EdFiStudentProgramAssociationService();

  group('test EdFiStudentProgramAssociationService', () {
    // Indicates the service being provided to the student by the program.
    // String serviceDescriptor
    test('to test the property `serviceDescriptor`', () async {
      // TODO
    });
