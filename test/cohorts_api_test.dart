...
/// tests for CohortsApi
void main() {
  // final instance = CohortsApi();

  group('tests for CohortsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteCohortById(String id, { String ifMatch }) async
    test('test deleteCohortById', () async {
      // TODO
    });
    ...
    test('test deletesCohorts', () async {
      // TODO
    });
    ...
    test('test getCohortsById', () async {
      // TODO
    });
    ...
    test('test getCohortsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesCohorts', () async {
      // TODO
    });
    ...
    //
    //Future postCohort(EdFiCohort edFiCohort) async
    test('test postCohort', () async {
      // TODO
    });
    ...
    //
    //Future putCohort(String id, EdFiCohort edFiCohort, { String ifMatch }) async
    test('test putCohort', () async {
      // TODO
    });
