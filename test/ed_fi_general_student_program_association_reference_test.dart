...
// tests for EdFiGeneralStudentProgramAssociationReference
void main() {
  // final instance = EdFiGeneralStudentProgramAssociationReference();

  group('test EdFiGeneralStudentProgramAssociationReference', () {
