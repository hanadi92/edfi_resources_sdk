...
/// tests for StudentProgramEvaluationsApi
void main() {
  // final instance = StudentProgramEvaluationsApi();

  group('tests for StudentProgramEvaluationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentProgramEvaluationById(String id, { String ifMatch }) async
    test('test deleteStudentProgramEvaluationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentProgramEvaluations', () async {
      // TODO
    });
    ...
    test('test getStudentProgramEvaluations', () async {
      // TODO
    });
    ...
    test('test getStudentProgramEvaluationsById', () async {
      // TODO
    });
    ...
    test('test getStudentProgramEvaluationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentProgramEvaluations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentProgramEvaluation(EdFiStudentProgramEvaluation edFiStudentProgramEvaluation) async
    test('test postStudentProgramEvaluation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentProgramEvaluation(String id, EdFiStudentProgramEvaluation edFiStudentProgramEvaluation, { String ifMatch }) async
    test('test putStudentProgramEvaluation', () async {
      // TODO
    });
