...
/// tests for StudentAcademicRecordsApi
void main() {
  // final instance = StudentAcademicRecordsApi();

  group('tests for StudentAcademicRecordsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentAcademicRecordById(String id, { String ifMatch }) async
    test('test deleteStudentAcademicRecordById', () async {
      // TODO
    });
    ...
    test('test deletesStudentAcademicRecords', () async {
      // TODO
    });
    ...
    test('test getStudentAcademicRecords', () async {
      // TODO
    });
    ...
    test('test getStudentAcademicRecordsById', () async {
      // TODO
    });
    ...
    test('test getStudentAcademicRecordsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentAcademicRecords', () async {
      // TODO
    });
    ...
    //
    //Future postStudentAcademicRecord(EdFiStudentAcademicRecord edFiStudentAcademicRecord) async
    test('test postStudentAcademicRecord', () async {
      // TODO
    });
    ...
    //
    //Future putStudentAcademicRecord(String id, EdFiStudentAcademicRecord edFiStudentAcademicRecord, { String ifMatch }) async
    test('test putStudentAcademicRecord', () async {
      // TODO
    });
