...
// tests for TrackedChangesEdFiFeederSchoolAssociationKey
void main() {
  // final instance = TrackedChangesEdFiFeederSchoolAssociationKey();

  group('test TrackedChangesEdFiFeederSchoolAssociationKey', () {
    ...
    // int feederSchoolId
    test('to test the property `feederSchoolId`', () async {
      // TODO
    });
