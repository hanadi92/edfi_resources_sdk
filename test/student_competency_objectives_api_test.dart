...
/// tests for StudentCompetencyObjectivesApi
void main() {
  // final instance = StudentCompetencyObjectivesApi();

  group('tests for StudentCompetencyObjectivesApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentCompetencyObjectiveById(String id, { String ifMatch }) async
    test('test deleteStudentCompetencyObjectiveById', () async {
      // TODO
    });
    ...
    test('test deletesStudentCompetencyObjectives', () async {
      // TODO
    });
    ...
    test('test getStudentCompetencyObjectives', () async {
      // TODO
    });
    ...
    test('test getStudentCompetencyObjectivesById', () async {
      // TODO
    });
    ...
    test('test getStudentCompetencyObjectivesPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentCompetencyObjectives', () async {
      // TODO
    });
    ...
    //
    //Future postStudentCompetencyObjective(EdFiStudentCompetencyObjective edFiStudentCompetencyObjective) async
    test('test postStudentCompetencyObjective', () async {
      // TODO
    });
    ...
    //
    //Future putStudentCompetencyObjective(String id, EdFiStudentCompetencyObjective edFiStudentCompetencyObjective, { String ifMatch }) async
    test('test putStudentCompetencyObjective', () async {
      // TODO
    });
