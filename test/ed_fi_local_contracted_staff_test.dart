...
// tests for EdFiLocalContractedStaff
void main() {
  // final instance = EdFiLocalContractedStaff();

  group('test EdFiLocalContractedStaff', () {
    // 
    // String id
    ...
    test('to test the property `localAccountReference`', () async {
      // TODO
    });
    ...
    test('to test the property `financialCollectionDescriptor`', () async {
      // TODO
    });
