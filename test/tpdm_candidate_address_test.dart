...
// tests for TpdmCandidateAddress
void main() {
  // final instance = TpdmCandidateAddress();

  group('test TpdmCandidateAddress', () {
    ...
    // List<TpdmCandidateAddressPeriod> periods (default value: const [])
