...
// tests for EdFiAcademicWeek
void main() {
  // final instance = EdFiAcademicWeek();

  group('test EdFiAcademicWeek', () {
    // 
    // String id
    ...
    test('to test the property `weekIdentifier`', () async {
      // TODO
    });
    ...
    test('to test the property `totalInstructionalDays`', () async {
      // TODO
    });
