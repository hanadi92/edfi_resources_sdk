...
// tests for EdFiStudentTitleIPartAProgramAssociation
void main() {
  // final instance = EdFiStudentTitleIPartAProgramAssociation();

  group('test EdFiStudentTitleIPartAProgramAssociation', () {
    // 
    // String id
    ...
    test('to test the property `titleIPartAParticipantDescriptor`', () async {
      // TODO
    });
    ...
    // List<EdFiStudentTitleIPartAProgramAssociationTitleIPartAProgramService> titleIPartAProgramServices (default value: const [])
    test('to test the property `titleIPartAProgramServices`', () async {
      // TODO
    });
