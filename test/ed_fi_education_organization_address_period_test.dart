...
// tests for EdFiEducationOrganizationAddressPeriod
void main() {
  // final instance = EdFiEducationOrganizationAddressPeriod();

  group('test EdFiEducationOrganizationAddressPeriod', () {
