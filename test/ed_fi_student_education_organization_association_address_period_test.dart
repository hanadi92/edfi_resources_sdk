...
// tests for EdFiStudentEducationOrganizationAssociationAddressPeriod
void main() {
  // final instance = EdFiStudentEducationOrganizationAssociationAddressPeriod();

  group('test EdFiStudentEducationOrganizationAssociationAddressPeriod', () {
