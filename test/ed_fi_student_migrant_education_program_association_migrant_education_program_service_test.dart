...
// tests for EdFiStudentMigrantEducationProgramAssociationMigrantEducationProgramService
void main() {
  // final instance = EdFiStudentMigrantEducationProgramAssociationMigrantEducationProgramService();

  group('test EdFiStudentMigrantEducationProgramAssociationMigrantEducationProgramService', () {
    ...
    test('to test the property `migrantEducationProgramServiceDescriptor`', () async {
      // TODO
    });
