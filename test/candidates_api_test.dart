...
void main() {
  // final instance = CandidatesApi();

  group('tests for CandidatesApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteCandidateById(String id, { String ifMatch }) async
    test('test deleteCandidateById', () async {
      // TODO
    });
    ...
    test('test deletesCandidates', () async {
      // TODO
    });
    ...
    test('test getCandidatesById', () async {
      // TODO
    });
    ...
    test('test getCandidatesPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesCandidates', () async {
      // TODO
    });
    ...
    //
    //Future postCandidate(TpdmCandidate tpdmCandidate) async
    test('test postCandidate', () async {
      // TODO
    });
    ...
    //
    //Future putCandidate(String id, TpdmCandidate tpdmCandidate, { String ifMatch }) async
    test('test putCandidate', () async {
      // TODO
    });
