...
// tests for EdFiStudentLanguageInstructionProgramAssociation
void main() {
  // final instance = EdFiStudentLanguageInstructionProgramAssociation();

  group('test EdFiStudentLanguageInstructionProgramAssociation', () {
    // 
    // String id
    ...
    // List<EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment> englishLanguageProficiencyAssessments (default value: const [])
    test('to test the property `englishLanguageProficiencyAssessments`', () async {
      // TODO
    });
    ...
    test('to test the property `englishLearnerParticipation`', () async {
      // TODO
    });
    ...
    // List<EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService> languageInstructionProgramServices (default value: const [])
    test('to test the property `languageInstructionProgramServices`', () async {
      // TODO
    });
