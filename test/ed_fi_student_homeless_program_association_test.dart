...
// tests for EdFiStudentHomelessProgramAssociation
void main() {
  // final instance = EdFiStudentHomelessProgramAssociation();

  group('test EdFiStudentHomelessProgramAssociation', () {
    // 
    // String id
    ...
    test('to test the property `awaitingFosterCare`', () async {
      // TODO
    });
    ...
    test('to test the property `homelessPrimaryNighttimeResidenceDescriptor`', () async {
      // TODO
    });
    ...
    // List<EdFiStudentHomelessProgramAssociationHomelessProgramService> homelessProgramServices (default value: const [])
    test('to test the property `homelessProgramServices`', () async {
      // TODO
    });
    ...
    test('to test the property `homelessUnaccompaniedYouth`', () async {
      // TODO
    });
