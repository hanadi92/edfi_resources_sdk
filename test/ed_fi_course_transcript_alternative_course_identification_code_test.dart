...
// tests for EdFiCourseTranscriptAlternativeCourseIdentificationCode
void main() {
  // final instance = EdFiCourseTranscriptAlternativeCourseIdentificationCode();

  group('test EdFiCourseTranscriptAlternativeCourseIdentificationCode', () {
    ...
    test('to test the property `courseIdentificationSystemDescriptor`', () async {
      // TODO
    });
