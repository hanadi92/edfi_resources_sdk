...
// tests for EdFiCommunityProvider
void main() {
  // final instance = EdFiCommunityProvider();

  group('test EdFiCommunityProvider', () {
    // 
    // String id
    ...
    // List<EdFiEducationOrganizationCategory> categories (default value: const [])
    ...
    test('to test the property `communityProviderId`', () async {
      // TODO
    });

    // EdFiCommunityOrganizationReference communityOrganizationReference
    test('to test the property `communityOrganizationReference`', () async {
      // TODO
    });
    ...
    test('to test the property `licenseExemptIndicator`', () async {
      // TODO
    });
