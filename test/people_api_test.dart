...
void main() {
  ...
  group('tests for PeopleApi', () {
    ...
    //
    //Future deletePersonById(String id, { String ifMatch }) async
    test('test deletePersonById', () async {
      // TODO
    });
    ...
    test('test getPeoplePartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesPeople', () async {
      // TODO
    });
    ...
    //
    //Future postPerson(EdFiPerson edFiPerson) async
    test('test postPerson', () async {
      // TODO
    });
    ...
    //
    //Future putPerson(String id, EdFiPerson edFiPerson, { String ifMatch }) async
    test('test putPerson', () async {
      // TODO
    });
