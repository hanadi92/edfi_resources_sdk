...
/// tests for StudentSpecialEducationProgramAssociationsApi
void main() {
  // final instance = StudentSpecialEducationProgramAssociationsApi();

  group('tests for StudentSpecialEducationProgramAssociationsApi', () {
    // Deletes an existing resource using the resource identifier.
    //
    // The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).
    //
    //Future deleteStudentSpecialEducationProgramAssociationById(String id, { String ifMatch }) async
    test('test deleteStudentSpecialEducationProgramAssociationById', () async {
      // TODO
    });
    ...
    test('test deletesStudentSpecialEducationProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentSpecialEducationProgramAssociations', () async {
      // TODO
    });
    ...
    test('test getStudentSpecialEducationProgramAssociationsById', () async {
      // TODO
    });
    ...
    test('test getStudentSpecialEducationProgramAssociationsPartitions', () async {
      // TODO
    });
    ...
    test('test keyChangesStudentSpecialEducationProgramAssociations', () async {
      // TODO
    });
    ...
    //
    //Future postStudentSpecialEducationProgramAssociation(EdFiStudentSpecialEducationProgramAssociation edFiStudentSpecialEducationProgramAssociation) async
    test('test postStudentSpecialEducationProgramAssociation', () async {
      // TODO
    });
    ...
    //
    //Future putStudentSpecialEducationProgramAssociation(String id, EdFiStudentSpecialEducationProgramAssociation edFiStudentSpecialEducationProgramAssociation, { String ifMatch }) async
    test('test putStudentSpecialEducationProgramAssociation', () async {
      // TODO
    });
