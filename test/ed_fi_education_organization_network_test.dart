...
// tests for EdFiEducationOrganizationNetwork
void main() {
  // final instance = EdFiEducationOrganizationNetwork();

  group('test EdFiEducationOrganizationNetwork', () {
    // 
    // String id
    ...
    test('to test the property `educationOrganizationNetworkId`', () async {
      // TODO
    });
    ...
    test('to test the property `networkPurposeDescriptor`', () async {
      // TODO
    });
