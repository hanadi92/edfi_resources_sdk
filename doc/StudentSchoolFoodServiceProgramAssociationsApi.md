# edfi_resources_sdk.api.StudentSchoolFoodServiceProgramAssociationsApi
...
> deleteStudentSchoolFoodServiceProgramAssociationById(id, ifMatch)
...
final api_instance = StudentSchoolFoodServiceProgramAssociationsApi();
final id = id_example; // String | A resource identifier that uniquely identifies the resource.
final ifMatch = ifMatch_example; // String | The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.

try {
    api_instance.deleteStudentSchoolFoodServiceProgramAssociationById(id, ifMatch);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->deleteStudentSchoolFoodServiceProgramAssociationById: $e\n');
}
```
...
> List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete> deletesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot)
...
try {
    final result = api_instance.deletesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->deletesStudentSchoolFoodServiceProgramAssociations: $e\n');
}
```
...
final directCertification = true; // bool | Indicates that the student's National School Lunch Program (NSLP) eligibility has been determined through direct certification.
...
try {
    final result = api_instance.getStudentSchoolFoodServiceProgramAssociations(offset, limit, pageToken, pageSize, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, directCertification, reasonExitedDescriptor, endDate, id, servedOutsideOfRegularSession, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->getStudentSchoolFoodServiceProgramAssociations: $e\n');
}
```
...
> EdFiStudentSchoolFoodServiceProgramAssociation getStudentSchoolFoodServiceProgramAssociationsById(id, ifNoneMatch, useSnapshot)
...
try {
    final result = api_instance.getStudentSchoolFoodServiceProgramAssociationsById(id, ifNoneMatch, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->getStudentSchoolFoodServiceProgramAssociationsById: $e\n');
}
```
...
try {
    final result = api_instance.getStudentSchoolFoodServiceProgramAssociationsPartitions(number, minChangeVersion, maxChangeVersion, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, directCertification, reasonExitedDescriptor, endDate, id, servedOutsideOfRegularSession, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->getStudentSchoolFoodServiceProgramAssociationsPartitions: $e\n');
}
```
...
> List<TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange> keyChangesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot)
...
try {
    final result = api_instance.keyChangesStudentSchoolFoodServiceProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->keyChangesStudentSchoolFoodServiceProgramAssociations: $e\n');
}
```
...
> postStudentSchoolFoodServiceProgramAssociation(edFiStudentSchoolFoodServiceProgramAssociation)
...
final api_instance = StudentSchoolFoodServiceProgramAssociationsApi();
final edFiStudentSchoolFoodServiceProgramAssociation = EdFiStudentSchoolFoodServiceProgramAssociation(); // EdFiStudentSchoolFoodServiceProgramAssociation | The JSON representation of the \"studentSchoolFoodServiceProgramAssociation\" resource to be created or updated.

try {
    api_instance.postStudentSchoolFoodServiceProgramAssociation(edFiStudentSchoolFoodServiceProgramAssociation);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->postStudentSchoolFoodServiceProgramAssociation: $e\n');
}
```
...
> putStudentSchoolFoodServiceProgramAssociation(id, edFiStudentSchoolFoodServiceProgramAssociation, ifMatch)
...
try {
    api_instance.putStudentSchoolFoodServiceProgramAssociation(id, edFiStudentSchoolFoodServiceProgramAssociation, ifMatch);
} catch (e) {
    print('Exception when calling StudentSchoolFoodServiceProgramAssociationsApi->putStudentSchoolFoodServiceProgramAssociation: $e\n');
}
```
