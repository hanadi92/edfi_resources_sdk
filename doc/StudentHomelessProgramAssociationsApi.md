# edfi_resources_sdk.api.StudentHomelessProgramAssociationsApi
...
> deleteStudentHomelessProgramAssociationById(id, ifMatch)
...
final api_instance = StudentHomelessProgramAssociationsApi();
final id = id_example; // String | A resource identifier that uniquely identifies the resource.
final ifMatch = ifMatch_example; // String | The ETag header value used to prevent the DELETE from removing a resource modified by another consumer.

try {
    api_instance.deleteStudentHomelessProgramAssociationById(id, ifMatch);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->deleteStudentHomelessProgramAssociationById: $e\n');
}
```
...
> List<TrackedChangesEdFiStudentHomelessProgramAssociationDelete> deletesStudentHomelessProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot)
...
try {
    final result = api_instance.deletesStudentHomelessProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->deletesStudentHomelessProgramAssociations: $e\n');
}
```
...
final homelessPrimaryNighttimeResidenceDescriptor = homelessPrimaryNighttimeResidenceDescriptor_example; // String | The primary nighttime residence of the student at the time the student is identified as homeless.
final awaitingFosterCare = true; // bool | State defined definition for awaiting foster care.
final homelessUnaccompaniedYouth = true; // bool | A homeless unaccompanied youth is a youth who is not in the physical custody of a parent or guardian and who fits the McKinney-Vento definition of homeless. Students must be both unaccompanied and homeless to be included as an unaccompanied homeless youth.
...
try {
    final result = api_instance.getStudentHomelessProgramAssociations(offset, limit, pageToken, pageSize, minChangeVersion, maxChangeVersion, totalCount, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, homelessPrimaryNighttimeResidenceDescriptor, awaitingFosterCare, homelessUnaccompaniedYouth, reasonExitedDescriptor, endDate, id, servedOutsideOfRegularSession, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->getStudentHomelessProgramAssociations: $e\n');
}
```
...
> EdFiStudentHomelessProgramAssociation getStudentHomelessProgramAssociationsById(id, ifNoneMatch, useSnapshot)
...
try {
    final result = api_instance.getStudentHomelessProgramAssociationsById(id, ifNoneMatch, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->getStudentHomelessProgramAssociationsById: $e\n');
}
```
...
try {
    final result = api_instance.getStudentHomelessProgramAssociationsPartitions(number, minChangeVersion, maxChangeVersion, beginDate, educationOrganizationId, programEducationOrganizationId, programName, programTypeDescriptor, studentUniqueId, homelessPrimaryNighttimeResidenceDescriptor, awaitingFosterCare, homelessUnaccompaniedYouth, reasonExitedDescriptor, endDate, id, servedOutsideOfRegularSession, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->getStudentHomelessProgramAssociationsPartitions: $e\n');
}
```
...
> List<TrackedChangesEdFiStudentHomelessProgramAssociationKeyChange> keyChangesStudentHomelessProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot)
...
try {
    final result = api_instance.keyChangesStudentHomelessProgramAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, useSnapshot);
    print(result);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->keyChangesStudentHomelessProgramAssociations: $e\n');
}
```
...
> postStudentHomelessProgramAssociation(edFiStudentHomelessProgramAssociation)
...
final api_instance = StudentHomelessProgramAssociationsApi();
final edFiStudentHomelessProgramAssociation = EdFiStudentHomelessProgramAssociation(); // EdFiStudentHomelessProgramAssociation | The JSON representation of the \"studentHomelessProgramAssociation\" resource to be created or updated.

try {
    api_instance.postStudentHomelessProgramAssociation(edFiStudentHomelessProgramAssociation);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->postStudentHomelessProgramAssociation: $e\n');
}
```
...
> putStudentHomelessProgramAssociation(id, edFiStudentHomelessProgramAssociation, ifMatch)
...
try {
    api_instance.putStudentHomelessProgramAssociation(id, edFiStudentHomelessProgramAssociation, ifMatch);
} catch (e) {
    print('Exception when calling StudentHomelessProgramAssociationsApi->putStudentHomelessProgramAssociation: $e\n');
}
```
